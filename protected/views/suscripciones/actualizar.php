...
<div class="ui-content c_cont_detail_prod">
    ...
    <input data-role="periodos-suscripcion" style="border: 1px solid grey" type="text" value="<?php echo $suscripcion->cantidadPeriodos ?>">
    <button data-role="actualizar-suscripcion" data-id-suscripcion="<?php echo $suscripcion->idSuscripcion ?>" class="ui-btn ui-input-btn ui-corner-all ui-shadow ui-btn-inline">Actualizar</button>
