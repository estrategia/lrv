<?php $this->pageTitle = "Acondicionador diario Pantene fuerza y reconstrucción | La Rebaja Virtual"; ?>
<?php
$this->metaTags = "
...
<meta name='keywords' content='acondicionador 3 minute Miracle, productos para el cabello, cuidado del cabello.'>
  <style>
    ...
    @font-face { font-family:Gotham-Black; src: url(" . Yii::app()->request->baseUrl . "/images/contenido/pantene/fonts/Gotham-Black.otf);}
    ...
    .nombre-vertical {-webkit-writing-mode: vertical-lr;-ms-writing-mode: tb-lr;writing-mode: vertical-lr;font-family: bebas-neue-regular;font-size: 30px;letter-spacing: 3px;margin-top: 34px;transform: rotate(180deg);-ms-transform:rotate(180deg);-webkit-transform:rotate(180deg);}
    ...
    .owl-pagination {margin-top: 35px;margin-bottom: 15px;}
    .owl-theme .owl-controls .owl-page span {background-color: #656565 !important;}
    a {text-decoration:none;}
    .marco-principal {margin-top: 35px;border: 10px solid #eeeff3;font-family:Gotham-Book;padding: 15px 50px;font-size: 16px;}
    .marco-principal .producto {width: 110px;margin-top: 25px}
    .beneficios {font-family:Gotham-Black;}
    .reference {font-family:Gotham-Book;font-size: 11px;}
    .gradient-mobile {
      background: rgba(255,255,255,1);
      background: -moz-linear-gradient(top, rgba(255,255,255,1) 0%, rgba(255,255,255,1) 36%, rgba(255,255,255,1) 73%, rgba(234,235,230,1) 100%);
      background: -webkit-gradient(left top, left bottom, color-stop(0%, rgba(255,255,255,1)), color-stop(36%, rgba(255,255,255,1)), color-stop(73%, rgba(255,255,255,1)), color-stop(100%, rgba(234,235,230,1)));
      background: -webkit-linear-gradient(top, rgba(255,255,255,1) 0%, rgba(255,255,255,1) 36%, rgba(255,255,255,1) 73%, rgba(234,235,230,1) 100%);
      background: -o-linear-gradient(top, rgba(255,255,255,1) 0%, rgba(255,255,255,1) 36%, rgba(255,255,255,1) 73%, rgba(234,235,230,1) 100%);
      background: -ms-linear-gradient(top, rgba(255,255,255,1) 0%, rgba(255,255,255,1) 36%, rgba(255,255,255,1) 73%, rgba(234,235,230,1) 100%);
...
<img class="img-responsive-m" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/pantene/banner-acondicionador-diario-mobile.jpg" alt="Acondicionador diario pantene, cabello hasta 10 veces más fuerte">
<div class="marco-principal gradient-mobile" style="margin: 45px 0 0;border: none;padding: 0 37px 25px;font-size: 15px;">
  <fieldset class="ui-grid-a">
  	<div class="ui-block-a">
  	  <p style="font-size: 23px;margin-left: 70px;" class="nombre-vertical" style="margin-top: 30px;">ACONDICIONADOR DIARIO </p>
  	</div>
  	<div class="ui-block-b">
      <img  style="width: 110px;" class="img-responsive-m" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/pantene/acondicionador-diario.png " alt="Acondicionador diario pantene">
  	</div>
  </fieldset>
  <p>Acondicionador reforzado con el poder de la ampolla/ampolleta, para cabello fuerte** y protegido contra el quiebre.  </p>
  <p>Fortalece de manera efectiva* el cabello debilitado e intensamente dañado**. Tiene más del doble de agentes acondicionadores que  el acondicionador regular Fuerza y Reconstrucción, es ideal para  cuando necesitas un poderoso y conveniente tratamiento  de reconstrucción semanal. </p>
  <p class="reference">*vs. Shampoo sin ingredientes acondicionadores. <br>
  **Fuerza contra el daño mecánico. </p>
  <a data-ajax="false" href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 119290 )) ?>"><img class="img-responsive-m" style="width: 60%;margin: 30px auto 0;display: block;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/pantene/btn-comprar.png" alt="Comprar"></a>
</div>
...
<?php else: ?>
<!--Versión escritorio-->
<img class="img-responsive" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/pantene/banner-acondicionador-diario.jpg" alt="Acondicionador diario Pantene, cabello hasta 10 veces más fuerte">
<div class="container">
<div class="row marco-principal">
  <div class="col-md-4">
    <div class="col-sm-3">
      <p class="nombre-vertical">ACONDICIONADOR DIARIO </p>
    </div>
    <div class="col-sm-9">
      <img class="img-responsive producto" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/pantene/acondicionador-diario.png" alt="Acondicionador diario pantene">
    </div>
  </div>
  <div class="col-md-8">
    <div class="row" style="margin-top: 50px;">
      <p>Acondicionador reforzado con el poder de la ampolla/ampolleta, <br>
       para cabello fuerte** y protegido contra el quiebre. </p>
      <p>Fortalece de manera efectiva* el cabello debilitado e intensamente <br>
       dañado**. Tiene más del doble de agentes acondicionadores que <br>
       el acondicionador regular Fuerza y Reconstrucción, es ideal para <br>
       cuando necesitas un poderoso y conveniente tratamiento <br>
       de reconstrucción semanal.  </p>
    </div>
    <div class="row" style="margin-top:20px;">
      ...
      <div class="col-sm-4">
        <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 119290 )) ?>"><img class="img-responsive" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/pantene/btn-comprar.png" alt="Comprar"></a>
      </div>
    </div>
  </div>
</div>
