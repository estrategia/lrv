...
$this->metaTags = "<meta http-equiv='X-UA-Compatible' content='IE=edge'>
  ...
  <meta name='keywords' content='cicatricure, cicatricure gel, cicatricure beauty care.'>
    ...
    .block-gray {background-color: #f0f0f0;text-align: center;color: #7358AA;font-family: OpenSans-SemiBold;height: 354.6px;font-size: 18px;align-items: center;display: flex;}
...
<div class="row" style="background-color: #7358aa;margin-top: 60px;padding: 20px;">
  <div class="col-sm-5 col-md-5">
    <img class="img-responsive" style="margin: 15px 0 30px;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cicatricure/cicatrices-y-estrias.png">
