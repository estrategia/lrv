<?php $this->pageTitle = "Cicatricure gel- La Rebaja Virtual"; ?>
<?php
$this->metaTags = "<meta http-equiv='X-UA-Compatible' content='IE=edge'>
  ...
  <meta name='keywords' content='cicatricure, cicatricure gel, cicatricure beauty care.'>
    ...
    .header {background-color:#7358aa;}
    .header .logo {margin:0 auto;}
    .main-title {font-family:Merriweather-Light;color:#333333;text-align:center;margin-bottom: 0px;}
    .main-title::after {content: '';height: 2px;width: 320px;margin-top: 25px;background-color: #7358aa;display: block;margin: 5px auto;}
    ...
    h2 {font-family: OpenSans-SemiBold !important;color: #7358AA !important;text-align: center;font-size: 20px !important;}
    ...
    .border {border:1px solid #7358AA;padding: 10px 30px;}
    .intro {font-family: OpenSans-Light;color: #666666;font-size: 14px;text-align:center;}
    .more {color: #7358AA;text-decoration: underline;font-family: Merriweather-Light;font-size: 14px;text-align: center;display: block;}
    .more:hover {color: #7358AA;text-decoration: underline;}
    .comprar {font-family: OpenSans-Light;color: #fff;background-color: #7358AA;border: 1px solid #cccccc;text-align: center;display: block;padding: 7px;margin-top: 15px;}
    ...
    .comprar-large {font-family: OpenSans-Light;color: #7358aa;background-color: #fff;text-align: center;display: block;padding: 7px;width: 200px;margin: 15px auto 0;}
    .comprar-large:hover {color:#7358aa;}
    .title-white {font-family:OpenSans-SemiBold;color:#fff !important;font-size:15px;margin-bottom: 20px;}
    .text-white{font-family:Merriweather-Light; color:#fff;margin-bottom: 20px;}
    .block-gray {background-color: #f0f0f0;text-align: center;color: #7358AA;font-family: OpenSans-SemiBold;height: 386.6px;font-size: 18px;align-items: center;display: flex;}
    .block-gray p {margin: 0 auto;letter-spacing: 1px;}
    .block-gray:hover{background-color: #7358aa;color: #f0f0f0;-webkit-transition: 0.2s ease;-moz-transition: 0.2s ease;-o-transition: 0.2s ease;transition: 0.2s ease;}
    .owl-pagination { margin-top: 40px !important;}
    .owl-theme .owl-controls .owl-page span {background-color: #7358aa !important;}
    .precio {text-align: center;font-weight: bold;font-family: OpenSans-Light;margin:0;font-size: 15px;}
</style>
";
?>
...
<h1 class="main-title" style="padding: 0 15px;font-size: 25px;">¿Tienes cicatrices?</h1>
<img class="img-responsive-m"  style="margin-top: -5px;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cicatricure/banner-gel.jpg">
<div class="parrafo animate1 wow zoomIn" data-wow-offset="100" style="padding:0 15px;">
  <p>Que la vida deje marcas en tu piel es inevitable, pero puedes cuidarlas y ayudar a reducir su tamaño y visibilidad.</p>
</div>
<h2 class="wow rubberBand" data-wow-offset="100" style="margin-top: 30px !important;">CÓMPRALO AHORA EN LAREBAJAVIRTUAL.COM</h2>
<div style="background-color: #7358aa;margin-top: 60px;padding: 20px;">
  <img class="img-responsive-m" style="margin: 15px 0 30px;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cicatricure/cicatrices-y-estrias.png">
  <a style="margin-top: -15px;text-decoration: none;" href="<?php echo CController::createUrl('/contenido/ver', array('tipo' => 'grupo', 'contenido' => 2401)) ?>" class="comprar-large">COMPRAR</a>
  <h3 class="title-white" style="margin-top:50px;">CICATRICURE GEL</h3>
  <p class="text-white">La efectividad de Cicatricure Gel para mejorar la apariencia de las cicatrices y las estrías, se debe a los componentes de su exclusiva fórmula comprobada gracias al estudio de eficacia cosmética instrumental, en donde la combinación exclusiva de extractos naturales inmersos en una formulación dermocosmética diseñada en concentraciones adecuadas, dan excelentes resultados en cicatrices, marcas por quemaduras o estrías por crecimiento, embarazo y aumento de peso.</p>
  <div style="margin-top: 40px;background-color:#fff;text-align: center;color: #7358AA;padding: 5px 70px;">
    <img class="img-responsive" style="margin: 0 auto;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cicatricure/reloj.jpg">
    <p>Aplique Cicatricure Gel cuatro veces al día durante ocho semanas.</p>
    <img class="img-responsive"  style="margin: 0 auto;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cicatricure/mano.jpg">
    <p>Aplicar generosamente sobre la piel higienizada con suaves masajes hasta que absorba.</p>
  </div>
</div>
...
<h1 class="main-title">¿Tienes cicatrices?</h1>
<img class="img-responsive"  style="margin-top: -5px;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cicatricure/banner-gel.jpg">
<div class="container">
  <div class="row parrafo animate1 wow zoomIn" data-wow-offset="100">
    <p>Que la vida deje marcas en tu piel es inevitable, pero puedes cuidarlas y ayudar a reducir su tamaño y visibilidad.</p>
  </div>
  <h2 class="wow rubberBand" data-wow-offset="100" style="margin-top: 30px !important;">CÓMPRALO AHORA EN LAREBAJAVIRTUAL.COM</h2>
<div class="row" style="background-color: #7358aa;margin-top: 60px;padding: 20px;">
  <div class="col-sm-5 col-md-5">
    <img class="img-responsive" style="margin:0px;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cicatricure/cicatrices-y-estrias.png">
    <p class="precio" style="color: #fff;font-size: 21px;"><?= ($gel == null) ? "--" : Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], $gel, Yii::app()->params->formatoMoneda['moneda']) ?></p>
    <a href="<?php echo CController::createUrl('/contenido/ver', array('tipo' => 'grupo', 'contenido' => 2401)) ?>" class="comprar-large">COMPRAR</a>
  </div>
  <div class="col-sm-6 col-md-6">
    <div class="row">
      <h3 class="title-white">CICATRICURE GEL</h3>
      <p class="text-white">La efectividad de Cicatricure Gel para mejorar la apariencia de las cicatrices y las estrías, se debe a los componentes de su exclusiva fórmula comprobada gracias al estudio de eficacia cosmética instrumental, en donde la combinación exclusiva de extractos naturales inmersos en una formulación dermocosmética diseñada en concentraciones adecuadas, dan excelentes resultados en cicatrices, marcas por quemaduras o estrías por crecimiento, embarazo y aumento de peso.</p>
    </div>
    <div class="row" style="background-color:#fff;text-align: center;color: #7358AA;padding: 5px 70px;">
      <div class="col-sm-6 col-md-6">
        <img class="img-responsive" style="margin: 0 auto;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cicatricure/reloj.jpg">
        <p>Aplique Cicatricure Gel<br>cuatro veces al día durante<br>ocho semanas.</p>
      </div>
      <div class="col-sm-6 col-md-6">
        <img class="img-responsive"  style="margin: 0 auto;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cicatricure/mano.jpg">
        <p>Aplicar generosamente<br>sobre la piel higienizada con<br>suaves masajes hasta<br>que absorba.</p>
      </div>
    </div>
  </div>
</div>
<div class="row" style="margin-top: 35px;">
    ...
    <div class="col-sm-3 col-md-3 wow fadeIn" data-wow-offset="160">
      <div class="border">
        ...
        <p class="intro">Protege tu mirada<br>&nbsp;</p>
        <a href="<?= Yii::app()->request->baseUrl ?>/cicatricure-contorno-ojos" class="more">Ver más información</a>
        <p class="precio" style="margin-top:15px;"><?= ($contorno_ojos == null) ? "--" : Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], $contorno_ojos, Yii::app()->params->formatoMoneda['moneda']) ?></p>
        <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 68091)) ?>" class="comprar">COMPRAR</a>
      </div>
    </div>
