<?php $this->pageTitle = "Acondicionador Pantene fuerza y reconstrucción | La Rebaja Virtual"; ?>
<?php
$this->metaTags = "
<meta http-equiv='X-UA-Compatible' content='IE=edge'>
<meta name='description' content='El Acondicionador Pantene® Fuerza y Reconstrucción fortalece tu cabello hasta las puntas en un 91%. Ingresa aquí y descubre todos sus beneficios.'>
<meta name='keywords' content='Productos para hidratar el cabello, acondicionador pantene, pantene 3 minute miracle.'>
  <style>
    ...
    .nombre-vertical {-webkit-writing-mode: vertical-lr;-ms-writing-mode: tb-lr;writing-mode: vertical-lr;font-family: bebas-neue-regular;font-size: 30px;letter-spacing: 3px;margin-top: 65px;transform: rotate(180deg);-ms-transform:rotate(180deg);-webkit-transform:rotate(180deg);}
...
<img class="img-responsive-m" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/pantene/banner-acondicionador-mobile.jpg" alt="Acondicionador pantene, cabello hasta 10 veces más fuerte">
<div class="marco-principal gradient-mobile" style="margin: 45px 0 0;border: none;padding: 0 37px 25px;font-size: 15px;">
  <fieldset class="ui-grid-a">
  	<div class="ui-block-a">
  	  <p style="font-size: 23px;margin-left: 70px;" class="nombre-vertical" style="margin-top: 30px;">ACONDICIONADOR</p>
  	</div>
  	<div class="ui-block-b">
      <img  style="width: 110px;" class="img-responsive-m" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/pantene/acondicionador.png " alt="Acondicionador pantene">
  	</div>
  </fieldset>
...
<?php else: ?>
<!--Versión escritorio-->
<img class="img-responsive" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/pantene/banner-acondicionador.jpg" alt="Acondicionador Pantene, cabello hasta 10 veces más fuerte">
<div class="container">
<div class="row marco-principal">
  <div class="col-md-4">
    <div class="col-sm-3">
      <p class="nombre-vertical">ACONDICIONADOR </p>
    </div>
    <div class="col-sm-9">
      <img class="img-responsive producto" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/pantene/acondicionador.png" alt="Acondicionador pantene">
    </div>
  </div>
  <div class="col-md-8">
    <div class="row" style="margin-top: 50px;">
      <p>Posee una tecnología inteligente que repara y <br>
