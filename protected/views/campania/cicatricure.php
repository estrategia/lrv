...
$this->metaTags = "<meta http-equiv='X-UA-Compatible' content='IE=edge'>
  ...
  <meta name='keywords' content='cicatricure, cicatricure gel, cicatricure beauty care.'>
    ...
    .main-title::after {content: '';height: 2px;width: 680px;margin-top: 25px;background-color: #e91d7b;display: block;margin: 5px auto;}
    ...
    .more:hover {color: #ff4392;text-decoration: underline;}
    ...
    .owl-theme .owl-controls .owl-page span {background-color: #ff4392 !important;}
...
<div class="header">
  <img class="img-responsive" style="margin: 0 auto;display: block;width: 300px;"src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cicatricure/cicatricure.png">
</div>
<h1 class="main-title" style="padding: 0 15px;font-size: 25px;">Cicatricure, la ciencia <br> que cuida tu piel</h1>
<img class="img-responsive-m"  style="margin-top: -5px;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cicatricure/banner-home.jpg">
<div class="parrafo animate1 wow zoomIn" data-wow-offset="100" style="padding:0 15px;">
  <p>Cicatricure ha asumido un constante compromiso con la investigación de nuevas tecnologías que contribuyen al bienestar de la piel de las personas.</p>
  <p style="margin-top:0px;">Gracias a un equipo profesional y a las mejores y más exclusivas fórmulas, Cicatricure evoluciona día a día para convertirse en el mejor aliado del cuidado personal. </p>
</div>
...
<section class="bg-gray">
  <div class="wow fadeInUp" data-wow-offset="150">
    ...
    <p class="texto-p">Cicatricure es la línea de productos especializados en el cuidado de la piel. Su línea de cremas ayuda a mantener tu piel hidratada y a mejorar la apariencia de las arrugas y líneas de expresión.</p>
    <h2 style="margin-top: 30px !important;">CUERPO Y CICATRICES</h2>
    <p class="texto-p">Cicatricure ha desarrollado una fórmula exclusiva con extractos de origen natural para cuidar y mejorar la apariencia de cicatrices, marcas por quemaduras o estrías en la piel.</p>
    <h2 style="margin-top: 30px !important;">OJOS</h2>
    <p class="texto-p">Cicatricure cuida la piel alrededor de tus ojos, ayudando a mejorar la apariencia de las arrugas y la coloración de las ojeras. Ideal para tener siempre una mirada joven y fresca. </p>
  </div>
</section>
...
<h1 class="main-title">Cicatricure, la ciencia que cuida tu piel</h1>
<img class="img-responsive"  style="margin-top: -5px;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cicatricure/banner-home.jpg">
<div class="container">
  <div class="row parrafo animate1 wow zoomIn" data-wow-offset="100">
    <p>Cicatricure ha asumido un constante compromiso con la investigación de nuevas tecnologías que contribuyen al <br>
     bienestar de la piel de las personas.</p>
    <p>Gracias a un equipo profesional y a las mejores y más exclusivas fórmulas, Cicatricure evoluciona día a día para <br>
    convertirse en el mejor aliado del cuidado personal. </p>
  </div>
  <h2 class="wow rubberBand" data-wow-offset="100" style="margin-top: 30px !important;">CÓMPRALO AHORA EN LAREBAJAVIRTUAL.COM</h2>
  <div class="row" style="margin-top: 35px;">
    <div class="col-sm-3 col-md-3 wow fadeIn" data-wow-offset="150">
      <div class="border">
        <img class="img-responsive" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cicatricure/cicatrices-y-estrias.png">
        <h3 class="nombre-producto">CICATRICURE <br> GEL</h3>
        <p class="intro">Gel para aplicar en<br>cicatrices y estrías.</p>
