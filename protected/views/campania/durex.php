    ...
    <div class="item" style="padding: 0 20px;">
      ...
      <div class="contenedor-info ">
        <div class="contenedor-product" style="padding: 25px !important;">
          ...
          <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' =>103180)) ?>"><img style="width: 100px;margin: 30px auto 0;display: block;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/durex/circle.png" alt="Compra online"></a>
        </div>
      </div>
    </div>
    <div class="item" style="padding: 0 20px;">
      ...
      <div class="contenedor-info ">
        <div class="contenedor-product" style="padding: 25px !important;">
          ...
          <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' =>105865)) ?>"><img style="width: 100px;margin: 30px auto 0;display: block;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/durex/circle.png" alt="Compra online"></a>
        </div>
      </div>
    </div>
    <div class="item" style="padding: 0 20px;">
      <img class="img-responsive" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/durex/productos/maximo-placer-durex.png" alt="Máximo placer">
        <div class="contenedor-info ">
          <div class="contenedor-product" style="padding: 25px !important;">
            ...
            <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' =>103179)) ?>"><img style="width: 100px;margin: 30px auto 0;display: block;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/durex/circle.png" alt="Compra online"></a>
          </div>
        </div>
      </div>
    <div class="item" style="padding: 0 20px;">
      ...
      <div class="contenedor-info ">
        <div class="contenedor-product" style="padding: 25px !important;">
          ...
          <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' =>105872)) ?>"><img style="width: 100px;margin: 30px auto 0;display: block;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/durex/circle.png" alt="Compra online"></a>
        </div>
      </div>
    </div>
    <div class="item" style="padding: 0 20px;">
      <img class="img-responsive" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/durex/productos/climax-mutuo-durex.png" alt="Climax mutuo">
        <div class="contenedor-info">
          <div class="contenedor-product" style="padding: 25px !important;">
            ...
            <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' =>110786)) ?>"><img style="width: 100px;margin: 30px auto 0;display: block;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/durex/circle.png" alt="Compra online"></a>
          </div>
        </div>
      </div>
    <div class="item" style="padding: 0 20px;">
      <img class="img-responsive" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/durex/productos/anillo-vibrador-durex.png" alt="Anillo vibrador">
        <div class="contenedor-info ">
          <div class="contenedor-product" style="padding: 25px !important;">
            ...
            <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' =>25068)) ?>"><img style="width: 100px;margin: 30px auto 0;display: block;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/durex/circle.png" alt="Compra online"></a>
          </div>
        </div>
    </div>
    <div class="item" style="padding: 0 20px;">
      ...
      <div class="contenedor-info ">
        <div class="contenedor-product" style="padding: 25px !important;">
          ...
          <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' =>25066)) ?>"><img style="width: 100px;margin: 30px auto 0;display: block;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/durex/circle.png" alt="Compra online"></a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container" style="padding:60px 200px;">
    <div id="info-producto1" class="row contenedor-info ">
      <div class="col-md-12 contenedor-product">
        ...
        <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' =>103180)) ?>"><img class="compra-producto" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/durex/circle.png" alt="Compra online"></a>
      </div>
    </div>
    <div id="info-producto2" class="row contenedor-info hide ">
      <div class="col-md-12 contenedor-product">
        ...
        <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' =>105865)) ?>"><img class="compra-producto" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/durex/circle.png" alt="Compra online"></a>
      </div>
    </div>
    <div id="info-producto3" class="row contenedor-info hide ">
      <div class="col-md-12 contenedor-product">
        ...
        <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' =>103179)) ?>"><img class="compra-producto" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/durex/circle.png" alt="Compra online"></a>
      </div>
    </div>
    <div id="info-producto4" class="row contenedor-info hide ">
      <div class="col-md-12 contenedor-product">
        ...
        <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' =>105872)) ?>"><img class="compra-producto" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/durex/circle.png" alt="Compra online"></a>
      </div>
    </div>
    <div id="info-producto5" class="row contenedor-info hide ">
      <div class="col-md-12 contenedor-product">
        ...
        <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' =>110786)) ?>"><img class="compra-producto" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/durex/circle.png" alt="Compra online"></a>
      </div>
    </div>
    <div id="info-producto6" class="row contenedor-info hide ">
      <div class="col-md-12 contenedor-product">
        ...
        <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' =>25068)) ?>"><img class="compra-producto" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/durex/circle.png" alt="Compra online"></a>
      </div>
    </div>
