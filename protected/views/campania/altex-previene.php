...
$this->metaTags = "<meta http-equiv='X-UA-Compatible' content='IE=edge'>
  ...
  <meta name='keywords' content='Altex, jabon altex, altex acné.'>
    ...
    .menu .active {background-position: 35px -8px;background-image: url(/lrv/images/contenido/altex/btn-menu.png);background-repeat: no-repeat;text-decoration:none;height: 154px;width: 100%;display: block;color:#fff;}
    ...
    .space {height:100px;}
    .lista {list-style: url(/lrv/images/contenido/altex/1-previene/item-list.png) ;font-family:SohoGothicPro-Regular ;font-size:20px;margin: 35px auto;}
...
<?php if ($this->isMobile): ?>
  <img class="img-responsive-m" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/altex/1-previene/previene.gif">
...
<div class="background">
  <div class="container">
    <img class="img-responsive" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/altex/1-previene/previene.gif">
