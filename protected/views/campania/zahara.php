...
<!--Versión escritorio-->
<?php else: ?>
<div class="sidebar-cart"><a href="#"><img class="img-responsive" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/coaspharma/zahara/btn-fijo.png"></a></div>
<section class="bg-main">
  <div class="container">
    ...
    <div class="row" style="padding: 0 100px;">
      ...
      <a href="#"><img class="compra" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/coaspharma/zahara/compra-online.png"></a>
    </div>
  </div>
...
<section class="bg-video">
  ...
  <center style="padding:0 25%;">
    <div class="video">
      <iframe width="560" height="315" src="https://www.youtube.com/embed/bu5IDmDxUA4?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe>
    </div>
  </center>
</section>
