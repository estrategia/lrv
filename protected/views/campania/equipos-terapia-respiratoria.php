<?php $this->pageTitle = "Cuidado en casa - Equipos terapia respiratoria | La Rebaja Virtual"; ?>
<?php
$this->metaTags = "
  ...
  <style>
    ...
    .bg-color {font-family:Campton-Book;background-color: #F2D383;text-align: center;color: #3F3730;font-size: 16px;padding: 25px;margin: 15px;}
    ...
    .roll-back {background-color: #F1F0EE;color: #3F3730;border-radius: 25px;padding: 25px 0px;margin: 0 25px;height: 298px;max-height: 298px;min-height: 298px;position: relative;}
...
<img class="img-responsive-m" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cuidado-en-casa/banner/05-bannerrespiratorio.jpg" alt="Terapia respiratoria">
<div class="content-banner" style="margin: -10px 25px;">
  ...
  <img width="320" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cuidado-en-casa/banner/05-equipos-terapia-respiratoria.jpg" alt="Terapia respiratoria">
  <p style="text-align: center;margin-top: 0px;margin-bottom: 30px;"> Los problemas respiratorios son<br> siempre una prioridad.</p>
</div>
<section class="row bg-color" style="margin: 0 0 20px;">
  Es por eso que en La Rebaja tenemos a tu disposición ​los dispositivos adecuados para tratamientos de patologías crónicas o para fines terapéuticos​ que ayudan al manejo de una buena ​respiración.
</section>
<div class="ui-grid-a line-categories" style="padding: 0 15px;">
    ...
    <div class="border-m">
      <a data-ajax="false" href="<?php echo CController::createUrl('/contenido/ver', array('tipo' => 'grupo', 'contenido' => 5116)) ?>"><img class="img-responsive-m"  style="width: 100%;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cuidado-en-casa/productos/nebulizadores.png" alt="Nebulizadores"></a>
      <p><span>Nebulizadores</span></p>
      <a data-ajax="false" href="<?php echo CController::createUrl('/contenido/ver', array('tipo' => 'grupo', 'contenido' => 5116)) ?>"><img class="img-responsive-m" style="width: 100%;"  src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cuidado-en-casa/referencias.jpg" alt=""></a>
    </div>
  </div>
</div>
...
<div class="row">
  <div class="col-sm-5 col-md-5">
    <div class="content-banner">
      ...
      <img class="img-responsive" width="400" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cuidado-en-casa/banner/05-equipos-terapia-respiratoria.jpg" alt="terapia respiratoria">
      <p>Los problemas respiratorios son<br> siempre una prioridad.</p>
    </div>
  </div>
  <div class="col-sm-7 col-md-7">
    <img class="img-responsive" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cuidado-en-casa/banner/05-bannerrespiratorio.jpg" alt="Equipo terapia respiratoria">
  </div>
</div>
...
<div class="container">
  <div class="row line-categories" style="margin-bottom: 60px;margin-top:25px;">
    ...
    <div class="col-sm-3 col-md-3">
      <div class="border">
        <a href="<?php echo CController::createUrl('/contenido/ver', array('tipo' => 'grupo', 'contenido' => 5116)) ?>"><img class="img-responsive" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cuidado-en-casa/productos/nebulizadores.png" alt="Nebulizadores"></a>
        <p><span>Nebulizadores</span></p>
        <a href="<?php echo CController::createUrl('/contenido/ver', array('tipo' => 'grupo', 'contenido' => 5116)) ?>"><img class="img-responsive" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cuidado-en-casa/referencias.jpg" alt=""></a>
      </div>
    </div>
  </div>
</div>
