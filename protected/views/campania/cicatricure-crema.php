<?php $this->pageTitle = "Cicatricure crema - La Rebaja Virtual"; ?>
<?php
$this->metaTags = "<meta http-equiv='X-UA-Compatible' content='IE=edge'>
  ...
  <meta name='keywords' content='cicatricure, cicatricure gel, cicatricure beauty care.'>
    ...
    .header {background-color:#e91d7b;}
    .header .logo {margin:0 auto;}
    .main-title {font-family:Merriweather-Light;color:#333333;text-align:center;margin-bottom: 0px;}
    .main-title::after {content: '';height: 2px;width:300px;margin-top: 25px;background-color:#e91d7b;display: block;margin: 5px auto;}
    ...
    h2 {font-family: OpenSans-SemiBold !important;color: #e91d7b !important;text-align: center;font-size: 20px !important;}
    ...
    .border {border:1px solid #e91d7b;padding: 10px 30px;}
    .intro {font-family: OpenSans-Light;color: #666666;font-size: 14px;text-align:center;}
    .more {color: #e91d7b;text-decoration: underline;font-family: Merriweather-Light;font-size: 14px;text-align: center;display: block;}
    .more:hover {color: #E91D7B;text-decoration: underline;}
    .comprar {font-family: OpenSans-Light;color: #fff;background-color: #e91d7b;border: 1px solid #cccccc;text-align: center;display: block;padding: 7px;margin-top: 15px;}
...
<div class="header">
  ...
  <h1 class="main-title" style="padding: 0 15px;font-size: 25px;">¿Tienes arrugas?</h1>
  <img class="img-responsive-m"  style="margin-top: -5px;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cicatricure/banner-crema.jpg">
  <div class="parrafo animate1 wow zoomIn" data-wow-offset="100" style="padding:0 15px;">
    <p>Tu piel se puede ver afectada por factores genéticos y ambientales. La falta de cuidado e hidratación son causas muy comunes del deterioro progresivo de cara, cuello y escote.<br>
    Entre más temprano se empiece con una rutina de cuidado, mejores resultados se obtendrán a largo plazo.
    </p>
  </div>
  <h2 class="wow rubberBand" data-wow-offset="100" style="margin-top: 30px !important;">CÓMPRALO AHORA EN LAREBAJAVIRTUAL.COM</h2>
  <div style="background-color:#e91d7b;margin-top: 60px;padding: 20px;">
    <img class="img-responsive-m" style="margin: 15px 0 30px;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cicatricure/lineas-de-expresion-y-arrugas.png">
    <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 64629)) ?>" class="comprar-large">COMPRAR</a>
    <h3 class="title-white" style="margin-top:50px;">CICATRICURE CREMA</h3>
      <p class="text-white">Siempre joven y bella Conoce la exclusiva fórmula Cicatricure Crema, combina ingredientes dermocosméticos que  ayudan a reducir la visibilidad de las arrugas y líneas de expresión. Úsala en rostro, cuello y escote.</p>
      <div style="background-color:#fff;text-align: center;color:#e91d7b;padding: 5px 20px;margin-top: 40px;">
        <img class="img-responsive" style="margin: 0 auto;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cicatricure/reloj-rosado.jpg">
        <p>Aplica por la mañana<br>y por la noche</p>
        <img class="img-responsive"  style="margin: 0 auto;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cicatricure/rostro.png">
        <p>Aplica sobre la piel limpia<br>en la cara, el cuello<br>y el escote</p>
        <img class="img-responsive"  style="margin: 0 auto;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cicatricure/movimientos.png">
        <p>Deben ser suaves<br>ascendentes hasta que<br>se absorba.</p>
      </div>
  </div>
...
<h1 class="main-title">¿Tienes arrugas?</h1>
<img class="img-responsive"  style="margin-top: -5px;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cicatricure/banner-crema.jpg">
<div class="container">
...
<div class="row" style="background-color:#e91d7b;margin-top: 60px;padding: 20px;">
  <div class="col-sm-5 col-md-5">
    <img class="img-responsive" style="0px;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cicatricure/lineas-de-expresion-y-arrugas.png">
    <p class="precio" style="color: #fff;font-size: 21px;"><?= ($crema == null) ? "--" : Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], $crema, Yii::app()->params->formatoMoneda['moneda']) ?></p>

    <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 64629)) ?>" class="comprar-large">COMPRAR</a>
  </div>
  <div class="col-sm-7 col-md-7">
    <div class="row">
      <h3 class="title-white">CICATRICURE CREMA</h3>
      <p class="text-white">
        Siempre joven y bella <br>
        Conoce la exclusiva fórmula Cicatricure Crema, combina ingredientes dermocosméticos que  ayudan a reducir la visibilidad de las arrugas y líneas de expresión. <br>
        Úsala en rostro, cuello y escote.
      </p>
    </div>
    <div class="row" style="background-color:#fff;text-align: center;color:#e91d7b;padding: 5px 20px;margin-top: 70px;">
