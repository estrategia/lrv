    ...
    <div class="container">
      ...
      <form id="formulario-mascota" class="formulario-registro" style="padding: 0px 20px;margin-top: 20px;" action=""  method="">
          <div class="col-sm-12 col-md-12">
            <input name='Mascotas[cedulaCliente]' type="text" placeholder="C&eacute;dula del amo">
            <div id='Mascotas_cedulaCliente_em' class="error text-danger"></div>
            <br>
            <input name='Mascotas[nombreCliente]' type="text" placeholder="Nombre del amo">
            <div id='Mascotas_nombreCliente_em' class="error text-danger"></div><br>
            <input name='Mascotas[fechaNacimientoCliente]' type="text" placeholder="Fecha de nacimiento">
            <div id='Mascotas_fechaNacimientoCliente_em' class="error text-danger"></div><br>
            ...
            <div id='Mascotas_codigoCiudad_em' class="error text-danger"></div><br>
            <input name='Mascotas[direccion]' type="text" placeholder="Dirección">
            <div id='Mascotas_direccion_em' class="error text-danger"></div><br>
            <input name='Mascotas[telefono]' type="text" placeholder="Teléfono o celular de contacto">
            <div id='Mascotas_telefono_em' class="error text-danger"></div><br>
            
            <input name='Mascotas[correo]' type="text" placeholder="Correo electr&oacute;nico">
            <div id='mascotas_correo_em' class="error text-danger"></div><br>
            <select name='Mascotas[tipoMascota]'>
              <option value="" selected="selected">- Tipo de mascota -</option>
              <option value="1">Perros</option>
              <option value="2">Gatos</option>
            </select>
            <div id='Mascotas_tipoMascota_em' class="error text-danger"></div><br/>
            <input name='Mascotas[nombreMascota]' type="text" placeholder="Nombre de la mascota">
            <div id='Mascotas_nombreMascota_em' class="error text-danger"></div><br/>
            <input name='Mascotas[edadMascota]' type="text" placeholder="Edad de la mascota">
            <div id='Mascotas_edadMascota_em' class="error text-danger"></div><br>
          </div>
          <div class="col-md-12">
    ...
    <div class="container">
      ...
      <form id="formulario-mascota" class="formulario-registro" action=""  method="post">
          <div class='row'>
           ...
           <div class='row'>
          		<div class="col-sm-6 col-md-6"> 
                   <input name='Mascotas[fechaNacimientoCliente]' type="text" placeholder="Fecha de nacimiento (aaaa-mm-dd)">
          ...
          <div class='row'>
          		<div class="col-sm-6 col-md-6">
	            <input name='Mascotas[correo]' type="text" placeholder="Correo electr&oacute;nico del amo">
