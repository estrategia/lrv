<?php $this->pageTitle = "Crema para peinar Pantene fuerza y reconstrucción | La Rebaja Virtual"; ?>
<?php
$this->metaTags = "
<meta http-equiv='X-UA-Compatible' content='IE=edge'>
<meta name='description' content='Conoce la Nueva Crema para Peinar Fuerza y Reconstrucción que Pantene® tiene para ti. Controla instantáneamente el frizz, dejando el cabello hidratado.'>
<meta name='keywords' content='Crema para peinar, crema para peinar pantene, cabello seco y maltratado.'>
  <style>
    ...
    .nombre-vertical {-webkit-writing-mode: vertical-lr;-ms-writing-mode: tb-lr;writing-mode: vertical-lr;font-family: bebas-neue-regular;font-size: 30px;letter-spacing: 3px;margin-top: 60px;transform: rotate(180deg);-ms-transform:rotate(180deg);-webkit-transform:rotate(180deg);}
    ...
    .marco-principal .producto {width: 130px;}
...
<img class="img-responsive-m" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/pantene/banner-crema-para-peinar-mobile.jpg" alt="Crema para peinar pantene, cabello hasta 10 veces más fuerte">
<div class="marco-principal gradient-mobile" style="margin: 45px 0 0;border: none;padding: 0 37px 25px;font-size: 15px;">
  <fieldset class="ui-grid-a">
  	<div class="ui-block-a">
  	  <p style="font-size: 25px;margin-left: 70px;" class="nombre-vertical" style="margin-top: 30px;">CREMA PARA PEINAR</p>
  	</div>
  	<div class="ui-block-b">
      <img  style="width: 110px;" class="img-responsive-m" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/pantene/crema-para-peinar.png " alt="Crema para peinar pantene">
  	</div>
  </fieldset>
  <p>Controla instantáneamente el frizz y el volumen, dejando el cabello suave e hidratado. </p>
  <p>Devuelve la suavidad a las zonas dañadas de cada hebra. </p>
  <p>Sensación ultra suave al aplicar. Desenreda fácilmente el cabello húmedo o seco. Diseñada para usarse con el sistema de Shampoo  y Acondicionador Pantene PRO-V® Fuerza y Reconstrucción. </p>
  <a data-ajax="false" href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 119292 )) ?>"><img class="img-responsive-m" style="width: 60%;margin: 30px auto 0;display: block;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/pantene/btn-comprar.png" alt="Comprar"></a>
</div>
...
<div style="margin-top:15px;" id="owl-productodetalle-inicio" class="owl-carousel owl-theme owl-productodetalle">
  ...
  <div class="item">
    <div class="contenedor-producto">
      ...
      <p>Actúa en las áreas más débiles</p>
...
<?php else: ?>
<!--Versión escritorio-->
<img class="img-responsive" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/pantene/banner-crema-para-peinar.jpg" alt="Crema para peinar Pantene, cabello hasta 10 veces más fuerte">
<div class="container">
<div class="row marco-principal">
  <div class="col-md-4">
    <div class="col-sm-3">
      <p class="nombre-vertical">CREMA PARA PEINAR</p>
    </div>
    <div class="col-sm-9">
      <img class="img-responsive producto" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/pantene/crema-para-peinar.png " alt="Crema para peinar pantene">
    </div>
  </div>
  <div class="col-md-8">
    <div class="row" style="margin-top: 50px;">
      <p>Controla instantáneamente el frizz y el volumen,dejando el cabello <br>
      suave e hidratado.</p>
      <p>Devuelve la suavidad a las zonas dañadas de cada hebra. </p>
      <p>Sensación ultra suave al aplicar. Desenreda fácilmente el cabello<br>
      húmedo o seco. Diseñada para usarse con el sistema de Shampoo <br>
      y Acondicionador Pantene PRO-V® Fuerza y Reconstrucción. </p>
    </div>
    <div class="row" style="margin-top:20px;">
      <div class="col-sm-8">
      </div>
      <div class="col-sm-4">
        <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 119292 )) ?>"><img class="img-responsive" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/pantene/btn-comprar.png" alt="Comprar"></a>
      </div>
    </div>
  </div>
</div>
