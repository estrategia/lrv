...
<?php
  ...
  .row-productos {background:#ffeee6; padding: 50px 0 25px;}
    ...
    .txt-footer {  text-align: center;    font-family:FrutigerLTStd-Roman;color: #414a35;margin-top: 80px;font-size: 15px;    padding-bottom: 15px;}
...
.contenedor-publicidad {
  height: 800px;
width: 100%;
background-image: url(".Yii::app()->request->baseUrl."/images/contenido/genfar-kids/achuu/fondo-producto.jpg);
...
<div>
  <div class="contenedor-publicidadm">
    ...
    <div class="contenedor-videom">
      <a href="#" class="bmd-modalButton" data-toggle="modal" data-bmdsrc="https://www.youtube.com/embed/vPOu-TWUfJo?rel=0&amp;controls=0&amp;showinfo=0" data-bmdwidth="800" data-bmdheight="400" data-target="#myModal" data-bmdvideofullscreen="true">
