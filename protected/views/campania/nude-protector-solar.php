<?php $this->pageTitle = "Nude Protector Solar | La Rebaja Virtual"; ?>
<?php
$this->metaTags = "
<meta http-equiv='X-UA-Compatible' content='IE=edge'>
<meta name='description' content='Descubre la línea de Protectores Solares NUDE® que cuidan tu piel de los rayos del sol por más tiempo. ¡Cómprala aquí y conoce todos sus beneficios!'>
<meta name='keywords' content='protector solar nude, mejores protectores solares, protectores solares'>
<style>
  ...
  .bg-protectores {border-radius: 30px;font-size: 20px;padding: 50px 0px 30px 75px;background-image:url(".Yii::app()->request->baseUrl."/images/contenido/nude/bg-protectores.png);background-size: 100%;}
  .btn-compra {width: 150px;margin-top: 15px;}
  .nombre-producto {font-family:Cocogoose-DemiBold;color:#001e70;font-size: 30px;margin-bottom: 20px;}
  .nombre-producto span {font-family:CocogoosePro-thin;}
  .nombre-producto span:nth-child(3) {font-size: 23px;font-family:brandon_med;font-weight:bold;margin-top:5px;display:block;}
  .intro-producto {font-weight: bold;font-family:CocogoosePro-thin;color:#001e70;font-size: 18px; }
  .bullet-producto {font-size: 26px; margin-top: 25px;font-family:brandon_med;color:#001e70;list-style-type:none;-webkit-padding-start: 0;-moz-padding-start: 0;padding-inline-start: 0;}
  .bullet-producto li:before {content:'° ';}
  .product-right {width: 345px;position: absolute;top: -116px;left: 25px;}
  .product-left {width: 380px;position: absolute;top: -105px;right: -32px;}
  .section-video {padding: 85px 0;background-image:url(".Yii::app()->request->baseUrl."/images/contenido/nude/fondo-video-Protectores.png);background-size:cover;}
...
<div id="owl-productodetalle-inicio" class="owl-carousel owl-theme slide-banner">
  <div class="item"><img class="img-responsive-m" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nude/mobile/banner-protectores-mobile.png" alt="Protector solar NUDE"></div>
...
<div class="bg-principal-m">
  <div class="patter-white">
    <div  id="owl-productodetalle-inicio" class="owl-carousel owl-theme owl-productodetalle">
      <div class="item">
        <img class="producto-m" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nude/protectores/protector-sport-spf-70-120ml.png" alt="">
        <div style="padding:0 30px;">
          <h3 class="nombre-producto" style="font-size: 20px;line-height: 20px;"><span>NUDE</span> PROTECTOR SOLAR<br><span style="font-size: 20px;">Sport SPF 70</span></h3>
          <p class="intro-producto" style="font-size: 15px;">El aliado perfecto que cuida tu piel.</p>
          <ul class="bullet-producto " style="font-size: 18px;">
            <li>Resistente a largas jornadas al aire libre.</li>
            <li>Contenido 120 ml.</li>
            <li>Ideal para deportistas de alto desempeño.</li>
          </ul>
          <a data-ajax="false" href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 104297 )) ?>"><img class="btn-compra-m" style="margin-top: 35px;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nude/btn-comprar.png" alt="Comprar"></a>
        </div>
      </div>
      <div class="item">
        <img class="producto-m" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nude/protectores/protector-baby-foam-spf-80.png" alt="">
        <div style="padding:0 30px;">
          <h3 class="nombre-producto" style="font-size: 20px;line-height: 20px;"><span>NUDE</span> PROTECTOR SOLAR<br><span>Foam Baby SPF 80</span></h3>
          <p class="intro-producto" style="font-size: 15px;">Protege la piel de tu bebé <br>de los rayos del sol.</p>
          <ul class="bullet-producto " style="font-size: 18px;">
            <li>Aprobado por Pediatras.</li>
            <li>Contenido 177 ml. </li>
            <li>Su textura suave y ligera se absorbe <br> <span style="margin-left: 15px;">rápidamente.</span></li>
          </ul>
          <a data-ajax="false" href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 115471 )) ?>"><img class="btn-compra-m" style="margin-top: 35px;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nude/btn-comprar.png" alt="Comprar"></a>
        </div>
      </div>
      <div class="item">
        <img class="producto-m" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nude/protectores/protector-con-repelente-spf-70.png" alt="">
        <div style="padding:0 30px;">
          <h3 class="nombre-producto" style="font-size: 20px;line-height: 20px;"><span>NUDE</span> PROTECTOR SOLAR<br><span>  Con repelente SPF 70</span></h3>
          <p class="intro-producto" style="font-size: 15px;">Ayuda a proteger tu piel de los rayos UV.</p>
          <ul class="bullet-producto " style="font-size: 18px;">
            <li>Resistente al agua y al sudor.</li>
            <li>Contenido 240 ml.</li>
            <li>Contiene repelente.</li>
          </ul>
          <a data-ajax="false" href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 106264 )) ?>"><img class="btn-compra-m" style="margin-top: 35px;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nude/btn-comprar.png" alt="Comprar"></a>
        </div>
      </div>
      <div class="item">
        <img class="producto-m" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nude/protectores/protector-foam-spf-80.png" alt="">
        <div style="padding:0 30px;">
          <h3 class="nombre-producto" style="font-size: 20px;line-height: 20px;"><span>NUDE</span> PROTECTOR SOLAR<br><span>Foam SPF 80</span></h3>
          <p class="intro-producto" style="font-size: 15px;">Cuida tu rostro y cuerpo por más tiempo.</p>
          <ul class="bullet-producto " style="font-size: 18px;">
            <li>Práctica aplicación.</li>
            <li>Contenido 177 ml.</li>
            <li>Reaplicable según tu necesidad.</li>
          </ul>
          <a data-ajax="false" href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 104351 )) ?>"><img class="btn-compra-m" style="margin-top: 35px;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nude/btn-comprar.png" alt="Comprar"></a>
        </div>
      </div>
      <div class="item">
        <img class="producto-m" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nude/protectores/orotector-display-spf-50.png" alt="">
        <div style="padding:0 30px;">
          <h3 class="nombre-producto" style="font-size: 20px;line-height: 20px;"><span>NUDE</span> PROTECTOR SOLAR<br><span>Display SPF 50</span></h3>
          <p class="intro-producto" style="font-size: 15px;">Tu piel humectada todo el día. </p>
            <ul class="bullet-producto " style="font-size: 18px;">
            <li>Contiene extracto de tomate.</li>
            <li>Contiene 24 sobres de 10 ml  cada uno.</li>
            <li>Protege la delicada piel de tu rostro <br> <span style="margin-left: 15px;">y cuello.</span></li>
          </ul>
          <a data-ajax="false" href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 16219 )) ?>"><img class="btn-compra-m" style="margin-top: 35px;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nude/btn-comprar.png" alt="Comprar"></a>
        </div>
      </div>
      <div class="item">
        <img class="producto-m" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nude/protectores/protector-portable-spf-30.png" alt="">
        <div style="padding:0 30px;">
          <h3 class="nombre-producto" style="font-size: 20px;line-height: 20px;"><span>NUDE</span> PROTECTOR SOLAR<br><span>Portable SPF 30</span></h3>
          <p class="intro-producto" style="font-size: 15px;">Tu compañero ideal todos los días.</p>
          <ul class="bullet-producto " style="font-size: 18px;">
            <li>Ideal para proteger la piel <br>de tu rostro y cuerpo.</li>
            <li>Contenido 40 ml.</li>
            <li>Recomendado para todo tipo de piel.</li>
          </ul>
          <a data-ajax="false" href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 103569 )) ?>"><img class="btn-compra-m" style="margin-top: 35px;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nude/btn-comprar.png" alt="Comprar"></a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img class="img-responsive" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nude/banner-protector-solar.png" alt="Protector solar NUDE">
      </div>
      <div class="item">
  ...
  <div class="container">
    <div class="row menu">
      <div class="col-sm-4 col-md-4">
        <a class=""  href="<?= Yii::app()->request->baseUrl ?>/nude-protectores-solares"><img class="img-responsive item-menu animate1 wow pulse" data-wow-offset="50" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nude/protector-solar.png" alt="Protector solar NUDE"></a>
      </div>
      <div class="col-sm-4 col-md-4">
    ...
    <section class="row wow fadeInRight" data-wow-offset="40" style="margin-bottom: 100px;margin-bottom: 60px;">
      <div class="col-md-8 col-md-offset-2">
        <h3 class="nombre-producto" style="margin-left: 75px;"><span>NUDE</span> PROTECTOR SOLAR<br><span>Sport SPF 70</span></h3>
        <div class="row bg-protectores">
          <div class="col-sm-8 col-md-8">
            <p class="intro-producto ">El aliado perfecto que cuida tu piel.</p>
            <ul class="bullet-producto ">
              <li>Resistente a largas jornadas al aire libre.</li>
              <li>Contenido 120 ml.</li>
              <li>Ideal para deportistas de alto desempeño.</li>
            </ul>
            <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 104297 )) ?>"><img class="btn-compra" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nude/btn-comprar.png" alt="Comprar"></a>
          </div>
          <div class="col-sm-4 col-md-4">
            <img class="product-right" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nude/protectores/protector-sport-spf-70-120ml.png" alt="">
          </div>
        </div>
      </div>
    </section>
    <section class="row wow fadeInLeft" data-wow-offset="40" style="margin-bottom: 100px;margin-bottom: 60px;">
      <div class="col-md-8 col-md-offset-2">
        <h3 class="nombre-producto" style="margin-left: 199px;"><span>NUDE</span> PROTECTOR SOLAR<br><span>Foam Baby SPF 80</span></h3>
        <div class="row bg-protectores">
          <div class="col-sm-2 col-md-2">
            <img class="product-left" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nude/protectores/protector-baby-foam-spf-80.png" alt="">
          </div>
          <div class="col-sm-8 col-md-8">
            <p class="intro-producto ">Protege la piel de tu bebé <br>de los rayos del sol.</p>
            <ul class="bullet-producto ">
              <li>Aprobado por Pediatras.</li>
              <li>Contenido 177 ml. </li>
              <li style="line-height: 25px;margin-bottom: 10px;">Su textura suave y ligera se absorbe <br> <span style="margin-left: 15px;">rápidamente.</span></li>
            </ul>
            <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 115471 )) ?>"><img class="btn-compra" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nude/btn-comprar.png" alt="Comprar"></a>
          </div>
        </div>
      </div>
    </section>
    <section class="row wow fadeInRight" data-wow-offset="40" style="margin-bottom: 100px;margin-bottom: 60px;">
      <div class="col-md-8 col-md-offset-2">
        <h3 class="nombre-producto" style="margin-left: 75px;"><span>NUDE</span> PROTECTOR SOLAR<br><span>  Con repelente SPF 70</span></h3>
        <div class="row bg-protectores">
          <div class="col-sm-8 col-md-8">
            <p class="intro-producto ">Ayuda a proteger tu piel de los rayos UV.</p>
            <ul class="bullet-producto ">
              <li>Resistente al agua y al sudor.</li>
              <li>Contenido 240 ml.</li>
              <li>Contiene repelente.</li>
            </ul>
            <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 106264 )) ?>"><img class="btn-compra" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nude/btn-comprar.png" alt="Comprar"></a>
          </div>
          <div class="col-sm-4 col-md-4">
            <img class="product-right" style="width: 360px;top: -154px;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nude/protectores/protector-con-repelente-spf-70.png" alt="">
          </div>
        </div>
      </div>
    </section>
    <section class="row wow fadeInLeft" data-wow-offset="40" style="margin-bottom: 100px;margin-bottom: 60px;">
      <div class="col-md-8 col-md-offset-2">
        <h3 class="nombre-producto" style="margin-left: 199px;"><span>NUDE</span> PROTECTOR SOLAR<br><span>Foam SPF 80</span></h3>
        <div class="row bg-protectores">
          <div class="col-sm-2 col-md-2">
            <img class="product-left" style="width: 350px;top: -124px;right: -15px;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nude/protectores/protector-foam-spf-80.png" alt="">
          </div>
          <div class="col-sm-8 col-md-8">
            <p class="intro-producto ">Cuida tu rostro y cuerpo por más tiempo.</p>
            <ul class="bullet-producto ">
              <li>Práctica aplicación.</li>
              <li>Contenido 177 ml.</li>
              <li>Reaplicable según tu necesidad.</li>
            </ul>
            <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 104351 )) ?>"><img class="btn-compra" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nude/btn-comprar.png" alt="Comprar"></a>
          </div>
        </div>
      </div>
    </section>
    <section class="row wow fadeInRight" data-wow-offset="40" style="margin-bottom: 100px;margin-bottom: 60px;">
      <div class="col-md-8 col-md-offset-2">
        <h3 class="nombre-producto" style="margin-left: 75px;"><span>NUDE</span> PROTECTOR SOLAR<br><span>Display SPF 50</span></h3>
        <div class="row bg-protectores">
          <div class="col-sm-9 col-md-9">
            <p class="intro-producto ">Tu piel humectada todo el día. </p>
            <ul class="bullet-producto ">
              <li>Contiene extracto de tomate.</li>
              <li>Contiene 24 sobres de 10 ml  cada uno.</li>
              <li>Protege la delicada piel de tu rostro y cuello.</li>
            </ul>
            <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 16219 )) ?>"><img class="btn-compra" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nude/btn-comprar.png" alt="Comprar"></a>
          </div>
          <div class="col-sm-3 col-md-3">
            <img class="product-right" style="width: 360px;top: -40px;left: -20px;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nude/protectores/orotector-display-spf-50.png" alt="">
          </div>
        </div>
      </div>
    </section>
    <section class="row wow fadeInLeft" data-wow-offset="40" style="margin-bottom: 100px;margin-bottom: 60px;">
      <div class="col-md-8 col-md-offset-2">
        <h3 class="nombre-producto" style="margin-left: 199px;"><span>NUDE</span> PROTECTOR SOLAR<br><span>Portable SPF 30</span></h3>
        <div class="row bg-protectores">
          <div class="col-sm-2 col-md-2">
            <img class="product-left" style="width: 370px;top: -36px;right: -19px;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nude/protectores/protector-portable-spf-30.png" alt="">
          </div>
          <div class="col-sm-8 col-md-8">
            <p class="intro-producto ">Tu compañero ideal todos los días.</p>
            <ul class="bullet-producto ">
              <li style="line-height: 25px;margin-bottom: 10px;">Ideal para proteger la piel <br> <span style="margin-left: 15px;">de tu rostro y cuerpo.</span></li>
              <li>Contenido 40 ml.</li>
              <li>Recomendado para todo tipo de piel.</li>
            </ul>
            <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 103569 )) ?>"><img class="btn-compra" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nude/btn-comprar.png" alt="Comprar"></a>
          </div>
        </div>
      </div>
    </section>
