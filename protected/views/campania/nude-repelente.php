<?php $this->pageTitle = "Nude Repelente | La Rebaja Virtual"; ?>
<?php
$this->metaTags = "
<meta http-equiv='X-UA-Compatible' content='IE=edge'>
<meta name='description' content='Conoce la línea de Repelentes NUDE® para que disfrutes de un día de sol inolvidable con tu familia sin preocuparte por los mosquitos. ¡Cómprala aquí!'>
<meta name='keywords' content='Repelente para mosquitos, repelente de insectos, antimosquitos, repelente'>
<style>
  ...
  .bg-repelente {border-radius: 30px;font-size: 20px;padding: 50px 0px 30px 75px;background-image:url(".Yii::app()->request->baseUrl."/images/contenido/nude/bg-repelente.png);background-size: 100%;}
  ...
  .product-right {width: 355px;position: absolute;top: -70px;left: -40px;}
  .product-left {width: 400px;position: absolute;top: -191px;right: -40px;}
  .section-video {padding: 85px 0;background-image:url(".Yii::app()->request->baseUrl."/images/contenido/nude/fondo-video-repelentes.png);background-size:cover;}
...
<div id="owl-productodetalle-inicio" class="owl-carousel owl-theme slide-banner">
  <div class="item"><img class="img-responsive-m" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nude/mobile/banner-repelente.png" alt="Repelente NUDE"></div>
...
<div class="bg-principal-m">
  <div class="patter-white">
    <div  id="owl-productodetalle-inicio" class="owl-carousel owl-theme owl-productodetalle">
      <div class="item">
        <img class="producto-m" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nude/repelente/repelente-spray-120-ml.png" alt="">
        <div style="padding:0 30px;">
          <h3 class="nombre-producto" style="font-size: 20px;line-height: 20px;"><span>NUDE</span> REPELENTE<br><span style="font-size: 20px;">Spray 120ml</span></h3>
          <p class="intro-producto" style="font-size: 15px;">Tu piel protegida día a día.</p>
          <ul class="bullet-producto " style="font-size: 18px;">
            <li>Deliciosa fragancia. <br> <span style="margin-left: 15px;"> ¡No huele a repelente!</span></li>
            <li>Contenido 120 ml. </li>
            <li>De textura liviana, sin brillo <br> <span style="margin-left: 15px;">  ni sensación grasosa.</span></li>
          </ul>
          <a data-ajax="false" href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 114688 )) ?>"><img class="btn-compra-m" style="margin-top: 35px;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nude/btn-comprar.png" alt="Comprar"></a>
        </div>
      </div>
      <div class="item">
        <img class="producto-m" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nude/repelente/repelente-roll-on-60-ml.png" alt="">
        <div style="padding:0 30px;">
          <h3 class="nombre-producto" style="font-size: 20px;line-height: 20px;"><span>NUDE</span> REPELENTE<br><span>Roll On 60ml</span></h3>
          <p class="intro-producto" style="font-size: 15px;">Protege tu cuerpo de los mosquitos.</p>
          <ul class="bullet-producto " style="font-size: 18px;">
            <li>Contiene extractos de caléndula, <br> <span style="margin-left: 15px;">  manzanilla y lavanda.</span></li>
            <li>Contenido 60 ml.</li>
            <li>Ideal para quienes les encanta<br> <span style="margin-left: 15px;">  el exterior y la naturaleza.</span></li>
          </ul>
          <a data-ajax="false" href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 114687 )) ?>"><img class="btn-compra-m" style="margin-top: 35px;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nude/btn-comprar.png" alt="Comprar"></a>
        </div>
      </div>
      <div class="item">
        <img class="producto-m" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nude/repelente/repelente-aerosol.png" alt="">
        <div style="padding:0 30px;">
          <h3 class="nombre-producto" style="font-size: 20px;line-height: 20px;"><span>NUDE</span> REPELENTE<br><span>Aerosol 160ml</span></h3>
          <p class="intro-producto" style="font-size: 15px;">Para vivir plenamente el placer de la naturaleza.</p>
          <ul class="bullet-producto " style="font-size: 18px;">
            <li>Resistente al agua y sin sensación <br> <span style="margin-left: 15px;">de piel grasosa.</span>  </li>
            <li>Contenido 160 ml.</li>
            <li>Fácil aplicación.</li>
          </ul>
          <a data-ajax="false" href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 114686 )) ?>"><img class="btn-compra-m" style="margin-top: 35px;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nude/btn-comprar.png" alt="Comprar"></a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    ...
    <section class="row wow fadeInLeft" data-wow-offset="40" style="margin-bottom: 100px;margin-bottom: 60px;">
      <div class="col-md-8 col-md-offset-2">
        <h3 class="nombre-producto" style="margin-left: 199px;"><span>NUDE</span> REPELENTE<br><span>Spray 120ml</span></h3>
        <div class="row bg-repelente">
          <div class="col-sm-2 col-md-2">
            <img class="product-left" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nude/repelente/repelente-spray-120-ml.png" alt="">
          </div>
          <div class="col-sm-10 col-md-10">
            <p class="intro-producto ">Tu piel protegida día a día.</p>
            <ul class="bullet-producto ">
              <li> Deliciosa fragancia. ¡No huele a repelente! </li>
              <li>Contenido 120 ml. </li>
              <li>De textura liviana, sin brillo <span>ni sensación grasosa.</span></li>
            </ul>
            <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 114688 )) ?>"><img class="btn-compra" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nude/btn-comprar.png" alt="Comprar"></a>
          </div>
        </div>
      </div>
    </section>
    <section class="row wow fadeInRight" data-wow-offset="40" style="margin-bottom: 100px;margin-bottom: 60px;">
      <div class="col-md-8 col-md-offset-2">
        <h3 class="nombre-producto" style="margin-left: 75px;"><span>NUDE</span> REPELENTE<br><span> Roll On 60ml</span></h3>
        <div class="row bg-repelente">
          <div class="col-sm-9 col-md-9">
            <p class="intro-producto ">Protege tu cuerpo de los mosquitos.</p>
            <ul class="bullet-producto ">
              <li style="line-height: 25px;margin-bottom: 10px;">Contiene extractos de caléndula, <br><span style="margin-left: 16px;">manzanilla y lavanda</span></li>
              <li style="margin-bottom: 10px;">Contenido 60 ml.</li>
              <li style="line-height: 25px;">Ideal para quienes les encanta<br><span style="margin-left: 16px;">el exterior y la naturaleza.</span></li>
            </ul>
            <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 114687 )) ?>"><img class="btn-compra" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nude/btn-comprar.png" alt="Comprar"></a>
          </div>
          <div class="col-sm-3 col-md-3">
            <img class="product-right" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nude/repelente/repelente-roll-on-60-ml.png" alt="">
          </div>
        </div>
      </div>
    </section>
    <section class="row wow fadeInLeft" data-wow-offset="40" style="margin-bottom: 100px;margin-bottom: 100px;">
      <div class="col-md-8 col-md-offset-2">
        <h3 class="nombre-producto" style="margin-left: 185px;"><span>NUDE</span> REPELENTE<br><span>Aerosol 160ml</span></h3>
        <div class="row bg-repelente">
          <div class="col-sm-2 col-md-2">
            <img class="product-left" style="width: 370px;top: -125px;right: -40px;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nude/repelente/repelente-aerosol.png" alt="">
          </div>
          <div class="col-sm-10 col-md-10">
            <p class="intro-producto ">Para vivir plenamente el placer de la naturaleza.</p>
            <ul class="bullet-producto ">
              <li style="line-height: 25px;margin-bottom: 10px;">Resistente al agua y sin sensación <br><span style="margin-left: 16px;">de piel grasosa.</span> </li>
              <li>Contenido 160 ml.</li>
              <li>Fácil aplicación.</li>
            </ul>
            <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 114686 )) ?>"><img class="btn-compra" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nude/btn-comprar.png" alt="Comprar"></a>
          </div>
        </div>
      </div>
    </section>
