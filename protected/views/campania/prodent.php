...
<div style="margin-top: 10px;padding: 0 15px">
  <a href="#" data-ajax="false"><img class="item-menu-m" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/coaspharma/prodent/prodent-crema-dental.png" alt="Pro-dent Crema dental"></a>
  <a href="#" data-ajax="false"><img class="item-menu-m" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/coaspharma/prodent/prodent-crema-dental-kids.png" alt="Pro-dent Crema dental Kids"></a>
  <a href="#" data-ajax="false"><img class="item-menu-m" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/coaspharma/prodent/prodent-enjuague-bucal.png" alt="Pro-dent Crema enjuague bucal"></a>
</div>

<div style="margin-bottom:50px; padding:0 15px;margin-top: 50px;" class="wow bounceInLeft" data-wow-offset="90">
  <h2 class="main-title" style="font-size: 25px;">CREMA DENTAL</h2>
  <h3 class="name-product" style="font-size: 25px;
margin-top: -8px;">Pro-Dent Blanqueadora</h3>
  <ul class="lista-descrip bullet-red">
    <li>Fortifica el esmalte dental para <br> reducir la incidencia de caries.</li>
    <li>Su uso continuo ayuda a mantener <br> dientes blancos por mas tiempo.</li>
  ...
  <section class="bg-anticaries">
      ...
      <div class="wow bounceInRight" data-wow-offset="220">
        ...
        <
          <ul class="lista-descrip bullet-green">
            ...
            <li>Con sabor a menta deja el<br>aliento fresco por más tiempo.</li>
          </ul>
  ...
  <div class="container">
    <div class="row menu">
      <div class="col-sm-4 col-md-4">
        <a href="#" class="item-menu active"><img src="<?= Yii::app()->request->baseUrl ?>/images/contenido/coaspharma/prodent/prodent-crema-dental.png" alt="Pro-dent Crema dental"></a>
      </div>
      <div class="col-sm-4 col-md-4">
        <a href="#" class="item-menu" ><img src="<?= Yii::app()->request->baseUrl ?>/images/contenido/coaspharma/prodent/prodent-crema-dental-kids.png" alt="Pro-dent Crema dental Kids"></a>
      </div>
      <div class="col-sm-4 col-md-4">
        <a href="#" class="item-menu"><img src="<?= Yii::app()->request->baseUrl ?>/images/contenido/coaspharma/prodent/prodent-enjuague-bucal.png" alt="Pro-dent Crema enjuague bucal"></a>
      </div>
    </div>
  </div>
</section>
<div class="container wow bounceInLeft" data-wow-offset="200">
...
<section class="bg-anticaries">
  <div class="container">
    <div class="row wow bounceInRight" data-wow-offset="220">
      <div class="col-md-12">
        <h2 class="main-title">CREMA DENTAL</h2>
        <h3 class="name-product">Pro-Dent Anticaries</h3>
      </div>
