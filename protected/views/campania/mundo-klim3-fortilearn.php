<?php $this->pageTitle = "Mundo Klim 3+ FortiLearn - La Rebaja Virtual"; ?>
<?php
  $this->metaTags = "
  <meta http-equiv='X-UA-Compatible' content='IE=edge'>
  <meta name='description' content='Klim 3+ FortiLearn contiene nutrientes que contribuyen al desarrollo cognitivo de los niños entre 3 y 5 años. Conozca más información aquí'>
  <meta name='keywords' content='nestle klim 3+, klim 3+ fortilearn, klim 3+'>
  <style>
    ...
    .main-bg {background-size: cover; background-image:url(".Yii::app()->request->baseUrl."/images/contenido/mundo-klim/klim-fortilearn/main-bg.jpg);}
    .flex-banner {display: flex;flex-direction: row;flex-wrap: wrap;justify-content: space-between;width:100%; max-width: 1000px; margin: 0 auto;}
    .flex-banner .column {width:50%;}
    .bg-cloud {background: url(".Yii::app()->request->baseUrl."/images/contenido/mundo-klim/klim-fortilearn/cloud.png); background-size: 55%; background-repeat: no-repeat; background-position: 13% 100%; }
    .txt-banner {font-family: VAGRoundedStd-Bold; color: #006424; text-align: center; font-size: 35px; margin-left: 25%; line-height: 36px; margin-top: 10%;}
    .pack-banner {width: 78%; max-width: 425px; margin: 15px auto 30px; display: block;}
    .info-producto { padding: 30px 40px; background: #fff url(".Yii::app()->request->baseUrl."/images/contenido/mundo-klim/klim-fortilearn/forma.png); border: 6px solid #019247; border-radius: 30px; display: flex; flex-direction: row; flex-wrap: wrap; justify-content: space-between; width: 100%; max-width: 1000px; margin: 50px auto 0; background-repeat: no-repeat; background-position: 90% bottom; background-size: 200px;}
    ...
    .line-products {background:#fff; padding: 50px 0; margin-top:50px;}
    ...
    .txt-footer {text-align: center; font-family: VAGRoundedStd-Bold; color: #249F4A; padding: 30px 0; font-size: 18px;margin:0;}
...
<?php $klim3_1700gr = Producto::consultarPrecio('47111', $this->objSectorCiudad) ?>
<?php $klim3_500gr = Producto::consultarPrecio('53020', $this->objSectorCiudad) ?>
<?php $klim3_1000gr = Producto::consultarPrecio('16368', $this->objSectorCiudad)?>

<!-- VERSION MOVIL -->
<?php if ($this->isMobile): ?>
<div class="main-bg">
    <div class="flex-banner bg-cloud" style="flex-direction: column; background-size: 90%; background-position: 50% 100%;">
      <div class="column" style="width: 100%;">
        <img class="img-responsive-m" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/mundo-klim/klim-fortilearn/que-contiene.png" alt="Que contiene Nestle klim FortiLearn">
    ...
    <section class="info-producto" style="flex-direction: column; max-width: 80%; width: 100%; padding: 20px;margin-top: 0;">
      ...
      <div class="txt-producto" style="width: 100%;">
        <h1 class="title-producto" style="text-align: center; font-size: 25px;">KLIM<sup>&reg;</sup> 3+ FORTILEARN<sup>&reg;</sup></h1>
        <h2 class="subtitle-producto" style="text-align: center; font-size: 14px;">CONTRIBUYEN AL DESARROLLO COGNITIVO</h2>
        <p class="main-txt" style="text-align: center;">Tu hijo potencializa su aprendizaje e imaginación,
        por lo cual su alimentación debe aportar nutrientes
        que ayuden a su desarrollo cognitivo. Incluye el
        alimento lacteo <span>KLIM<sup>&reg;</sup> 3+ FortiLearn<sup>&reg;</sup></span> que contiene
    ...
    <div class="video">
      <iframe width="560" height="315" src="https://www.youtube.com/embed/PALps6VxQBQ?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
    </div>
    ...
    <p class="txt-footer" style="font-size: 13px; padding: 25px;">Como parte de un estilo de vida saludable que incluye alimentación balanceada y actividad física regular</p>
  </div>
...
<?php else: ?>
<div class="main-bg">
  <div class="flex-banner bg-cloud">
    <div class="column ">
      <img class="img-responsive" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/mundo-klim/klim-fortilearn/que-contiene.png" alt="Que contiene Nestle klim FortiLearn">
      <p class="txt-banner">Contiene nutrientes que <br> contribuyen al normal <br> desarrollo cognitivo:</p>
    </div>
    <div class="column">
      <img class="pack-banner" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/mundo-klim/klim-fortilearn/pack-banner.png" alt="Nestle klim FortiLearn">
    </div>
  </div>
  ...
  <section class="info-producto">
    <div class="img-producto">
      <img src="<?= Yii::app()->request->baseUrl ?>/images/contenido/mundo-klim/klim-fortilearn/klim3-fortilearn.png" alt="Comprar Klim fortilearn">
    </div>
    <div class="txt-producto">
      <h1 class="title-producto">KLIM<sup>&reg;</sup> 3+ FORTILEARN<sup>&reg;</sup></h1>
      <h2 class="subtitle-producto">CONTRIBUYEN AL DESARROLLO COGNITIVO</h2>
      <p class="main-txt">Tu hijo potencializa su aprendizaje e imaginación, <br>
      por lo cual su alimentación debe aportar nutrientes <br>
      que ayuden a su desarrollo cognitivo. Incluye el <br>
      alimento lacteo <span>KLIM<sup>&reg;</sup> 3+ FortiLearn<sup>&reg;</sup></span> que contiene <br>
  ...
  <section class="content-products">
    <a href="#" class="bmd-modalButton"  data-toggle="modal" data-bmdSrc="https://www.youtube.com/embed/PALps6VxQBQ?rel=0&amp;showinfo=0" data-bmdWidth="800" data-bmdHeight="400" data-target="#myModal"  data-bmdVideoFullscreen="true">
      <img class="img-recetas" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/mundo-klim/klim-fortilearn/recetas.png" alt="Recetas Klim fortiprotect">
    </a>
