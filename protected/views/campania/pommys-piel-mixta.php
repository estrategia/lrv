<?php $this->pageTitle = "Pomys Piel mixta a grasa - La Rebaja Virtual"; ?>
<?php
...
'>
  ...
  <style>
    ...
    .image-container-mix {display:block;width: 100%;height:100%;background: url(".Yii::app()->request->baseUrl."/images/contenido/pomys/mixta-a-grasa/item-menu-hover.png),url(".Yii::app()->request->baseUrl."/images/contenido/pomys/mixta-a-grasa/item-menu.png);background-size: 100% 100%, 0% 0%;}
    .image-container-mix:hover {background-size: 0% 0%, 100% 100%;}
    ...
    .line-dotted {border-bottom: 6px dotted #02BDD4;width: 52%;display: block;margin-bottom: 20px;}
    ...
    .nombre-producto {color: #02BDD4;font-family: signika-negative-semibold;}
    .space {height: 35px;}
  ...
  <div class="pattern">
    <div style="padding:0 15%;">
      <a data-ajax="false" href="<?= Yii::app()->request->baseUrl ?>/pomys-toallas-desmaquilladoras-piel-mixta">
        <img class="img-responsive-m" style="margin-bottom:15px;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/pomys/mixta-a-grasa/item-menu-hover.png">
      </a>
    ...
    <div style="margin-top: 50px;padding:0 8%;">
      <h2 class="nombre-producto">Toallitas húmedas desmaquilladoras piel <br> mixta a grasa</h2>
      <span class="line-dotted"></span>
      <div class="flex-container">
        <img src="<?= Yii::app()->request->baseUrl ?>/images/contenido/pomys/mixta-a-grasa/icono-bullet.png">
        <span> Con vitaminas A,E Y C</span>
      </div>
      <div class="flex-container">
        <img src="<?= Yii::app()->request->baseUrl ?>/images/contenido/pomys/mixta-a-grasa/icono-bullet.png">
        <span> Con extracto de Alga marina</span>
      </div>
      <div class="flex-container">
        <img src="<?= Yii::app()->request->baseUrl ?>/images/contenido/pomys/mixta-a-grasa/icono-bullet.png">
        <span> Con ácido salicílico</span>
      </div>
      <div class="flex-container">
        <img src="<?= Yii::app()->request->baseUrl ?>/images/contenido/pomys/mixta-a-grasa/icono-bullet.png">
  ...
  <div class="bg-product">
    <div class="container padding" style="margin-top: 50px;">
        <div class="col-sm-6 col-md-6">
          <h2 class="nombre-producto">Toallitas húmedas desmaquilladoras <br> piel mixta a grasa</h2>
          <span class="line-dotted"></span>
          <div class="flex-container">
            <img src="<?= Yii::app()->request->baseUrl ?>/images/contenido/pomys/mixta-a-grasa/icono-bullet.png">
            <span> Con vitaminas A,E Y C</span>
