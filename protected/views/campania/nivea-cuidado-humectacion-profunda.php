<?php $this->pageTitle = "Nivea cuidado nutritivo | La Rebaja Virtual"; ?>
<?php
$this->metaTags = "
<meta http-equiv='X-UA-Compatible' content='IE=edge'>
<meta name='description' content='La nueva crema Nivea Cuidado Humectación Profunda te brinda má de 24 horas de hidratacion en la piel de tu rostro. Sin sensación grasosa.'>
<meta name='keywords' content='crema hidratante, crema facial, crema hidratante para la cara.'>
  <style>
...
<img class="img-responsive-m" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nivea/banner-sin-sensacion-grasosa.jpg" alt="Nivea sin sensacion grasosa">
<section class="bg-intro" style="padding: 20px 0 30px;margin-top: -5px;">
  ...
  <div class="intro" style="flex-direction: column;padding: 0 20px 0;">
    <div class="descripcion-producto" style="width: 100%;">
      <h1 class="titulo-principal" style="text-align: center;">NIVEA CUIDADO<span> NUTRITIVO </span></h1>
      <h2 class="sub-title" style="text-align: center;">¿QUIERES HIDRATACIÓN SIN SENSACIÓN GRASOSA?</h2>
      <p class="intro-texto" style="font-size: 14px;">NIVEA Cuidado - La crema que por primera vez ofrece hidratación intensiva sin dejar sensación grasosa en el rostro.</p>
      <ul class="lista" style="font-size: 14px;-webkit-padding-start: 10px;-moz-padding-start: 10px;padding-inline-start: 10px;">
        <li><span>Más de 24h de humectación*</span>  <br>
          *De la superficie de la piel. Después de 2 semanas de uso regular.<br>
          Basado en estudio de eficacia. Alemania, 2014.
        </li>
        <li> <span>Ayuda para Una piel notablemente más suave después del uso regular** </span> <br>
           **Basado en estudio de percepción. Alemania, 2014.
        </li>
    ...
    <div class="imagen-producto" style="width: 100%;padding: 0;background-position: center 76%;">
      <img class="img-responsive img-producto" style="margin: 25px auto;display: block;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nivea/nivea-facial.png" alt="Nivea cuidado nutritivo">
    ...
    <div id="owl-productodetalle-inicio" class="owl-carousel owl-theme owl-productodetalle">
        ...
        <div class="producto" style="width: 75%;margin: 0 auto;">
          ...
          <div class="descripcion">
            ...
            <p class="texto" style="font-size: 14px">Hidratación intensiva sin sensación grasosa
            en el rostro, además ayuda a prevenir
            manchas y unificar el tono <br> de tu piel.</p>
...
<!--VERSION ESCRITORIO-->
<?php else: ?>
<img class="img-responsive" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/nivea/banner-sin-sensacion-grasosa.jpg" alt="Nivea sin sensacion grasosa">
<section class="bg-intro">
  ...
  <div class="intro">
    ...
    <div class="descripcion-producto">
      <h1 class="titulo-principal">NIVEA CUIDADO<span> NUTRITIVO </span></h1>
      <h2 class="sub-title">¿QUIERES HIDRATACIÓN SIN SENSACIÓN GRASOSA?</h2>
      <p class="intro-texto">NIVEA Cuidado - La crema que por primera vez ofrece hidratación intensiva sin dejar sensación grasosa en el rostro.</p>
      <ul class="lista">
        <li><span>Más de 24h de humectación*</span>  <br>
          *De la superficie de la piel. Después de 2 semanas de uso regular.<br>
          Basado en estudio de eficacia. Alemania, 2014.
        </li>
        <li> <span>Ayuda para Una piel notablemente más suave <br>después del uso regular** </span> <br>
           **Basado en estudio de percepción. Alemania, 2014.
        </li>
        <li><span>Sin sensación grasosa***</span> <br>
            ***Basado en estudio de percepción. Alemania, 2014.
