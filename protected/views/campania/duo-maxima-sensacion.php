<?php $this->pageTitle = "Condones DUO Máxima sensación - La Rebaja Virtual"; ?>
<?php
...
<div class="container bg-gray">
  <div class="row">
    ...
    <div style="padding: 0 15px;margin-bottom: 15px;">
      ...
      <a href="<?= Yii::app()->request->baseUrl ?>/condones-duo-maxima-sensacion" data-ajax="false">
        <span class="item-menu active" style="margin-top: -5px;">MÁXIMA SENSACIÓN</span>
      </a>
    </div>
    <div style="padding: 0 15px;margin-bottom: 15px;">
      ...
      <a href="<?= Yii::app()->request->baseUrl ?>/condones-duo-seguridad-y-confianza" data-ajax="false">
        <span class="item-menu" style="margin-top: -5px;">SEGURIDAD Y CONFIANZA</span>
      </a>
    </div>
  </div>
  ...
  <div class="colum-white">
    ...
    <img class="img-responsive producto-m" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/duo/maxima-sensacion/duo-hot-action.png">
    <div class="colum-black" style="margin-left: -1px;">
      <h2 class="name-product" style="font-size: 42px;">DUO HOT ACTION</h2>
      <p class="descrip-product">Tiene un lubricante especial que brinca una excitante sensación caliente. Sube la temperatura del momento con DUO Hot Action.</p>
      <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 85250)) ?>" data-ajax="false"><img class="img-responsive-m " src="<?= Yii::app()->request->baseUrl ?>/images/contenido/duo/maxima-sensacion/btn-duo-hot-action.png"></a>
    </div>
  </div>
  <div style="height:70px;"></div>
  <div class="colum-white">
    <img class="img-responsive new-image" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/duo/nueva-imagen.png">
    <img class="img-responsive producto-m" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/duo/maxima-sensacion/duo-tornado.png">
    <div class="colum-black" style="margin-left: -1px;">
      <h2 class="name-product" style="font-size: 42px;line-height: 40px;">DUO TORNADO PASSION</h2>
      <p class="descrip-product">Especialmente diseñado con forma de tornado y estrías adicionales para que vivan una esperiencia única. Ella quedara tan impresionada que no vas a pasar de usarlo.</p>
      <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 104765)) ?>" data-ajax="false"><img class="img-responsive-m" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/duo/maxima-sensacion/btn-duo-tornado.png"></a>
    </div>
  </div>
  <div style="height:70px;"></div>
  <div class="colum-white">
    <img class="img-responsive new-image" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/duo/nueva-imagen.png">
    <img class="img-responsive producto-m" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/duo/maxima-sensacion/duo-g-sensation.png">
    <div class="colum-black" style="margin-left: -1px;">
      <h2 class="name-product" style="font-size: 42px;">DUO G-SENSATION</h2>
      <p class="descrip-product">Con puntos y estrías que intensifican el placer de ella. Vas a quedar tan bien que no sabrás si fuiste tú o el condón.</p>
      <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 50205)) ?>" data-ajax="false"><img class="img-responsive-m " src="<?= Yii::app()->request->baseUrl ?>/images/contenido/duo/maxima-sensacion/btn-duo-g-sensation.png"></a>
    </div>
  </div>
  <div style="height:70px;"></div>
  <div class="colum-white">
    <img class="img-responsive new-image" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/duo/nueva-imagen.png">
    <img class="img-responsive producto-m" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/duo/maxima-sensacion/duo-ultra-sensible.png">
    <div class="colum-black" style="margin-left: -1px;">
      <h2 class="name-product" style="font-size: 42px;line-height: 40px;">DUO ULTRASENSIBLE</h2>
      <p class="descrip-product">Con un diseño extra delgado que brinda máxima sensibilidad. Es tan delgado que vas a tener que revisar si verdaderamente lo tienes puesto.</p>
    <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 15761)) ?>" data-ajax="false"><img class="img-responsive-m " src="<?= Yii::app()->request->baseUrl ?>/images/contenido/duo/maxima-sensacion/btn-duo-ultra-sensible.png"></a>
    </div>
  </div>
  ...
  <div class="container bg-gray">
    <div class="row">
      ...
      <div class="col-sm-4 col-md-4" style="padding: 0 25px;">
        ...
        <a href="<?= Yii::app()->request->baseUrl ?>/condones-duo-maxima-sensacion">
          <span class="item-menu active">MÁXIMA SENSACIÓN</span>
        </a>
      </div>
      <div class="col-sm-4 col-md-4" style="padding: 0 25px;">
        ...
        <a href="<?= Yii::app()->request->baseUrl ?>/condones-duo-seguridad-y-confianza">
          <span class="item-menu">SEGURIDAD Y CONFIANZA</span>
        </a>
      </div>
    </div>
    ...
    <div class="row colum-white">
      <div class="col-sm-6 col-md-6">
        <img class="img-responsive new-image" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/duo/nueva-imagen.png">
        <img class="img-responsive producto" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/duo/maxima-sensacion/duo-hot-action.png">
      </div>
      <div class="col-sm-6 col-md-6 colum-black">
        <h2 class="name-product">DUO HOT ACTION</h2>
        <p class="descrip-product">Tiene un lubricante especial que brinda una excitante sensación caliente. Sube la temperatura del momento con DUO Hot Action.</p>
        <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 85250)) ?>"><img class="img-responsive btn-comprar" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/duo/maxima-sensacion/btn-duo-hot-action.png"></a>
      </div>
    </div>
    ...
    <div class="row colum-white">
      <div class="col-sm-6 col-md-6">
        <img class="img-responsive new-image" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/duo/nueva-imagen.png">
        <img class="img-responsive producto" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/duo/maxima-sensacion/duo-tornado.png">
      </div>
      <div class="col-sm-6 col-md-6 colum-black">
        <h2 class="name-product">DUO TORNADO PASSION</h2>
        <p class="descrip-product">Especialmente diseñado con forma de tornado y estrías adicionales para que vivan una esperiencia única. Ella quedara tan impresionada que no vas a pasar de usarlo.</p>
        <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 104765)) ?>" data-ajax="false"><img class="img-responsive btn-comprar" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/duo/maxima-sensacion/btn-duo-tornado.png"></a>
      </div>
    </div>
    <div style="height:130px;"></div>
    <div class="row colum-white">
      <div class="col-sm-6 col-md-6">
        <img class="img-responsive new-image" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/duo/nueva-imagen.png">
        <img class="img-responsive producto" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/duo/maxima-sensacion/duo-g-sensation.png">
      </div>
      <div class="col-sm-6 col-md-6 colum-black">
        <h2 class="name-product">DUO G-SENSATION</h2>
        <p class="descrip-product">Con puntos y estrías que intensifican el placer de ella. Vas a quedar tan bien que no sabrás si fuiste tú o el condón.</p>
        <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 50205)) ?>"><img class="img-responsive btn-comprar" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/duo/maxima-sensacion/btn-duo-g-sensation.png"></a>
      </div>
    </div>
    <div style="height:130px;"></div>
    <div class="row colum-white">
      <div class="col-sm-6 col-md-6">
        <img class="img-responsive new-image" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/duo/nueva-imagen.png">
        <img class="img-responsive producto" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/duo/maxima-sensacion/duo-ultra-sensible.png">
      </div>
      <div class="col-sm-6 col-md-6 colum-black">
        <h2 class="name-product">DUO ULTRASENSIBLE</h2>
        <p class="descrip-product">Con un diseño extra delgado que brinda máxima sensibilidad. Es tan delgado que vas a tener que revisar si verdaderamente lo tienes puesto.</p>
        <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 15761)) ?>"><img class="img-responsive btn-comprar" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/duo/maxima-sensacion/btn-duo-ultra-sensible.png"></a>
      </div>
    </div>
