        ...
        <div class="background-m">
            ...
            <section>
                <section class="filtro-m" style="text-align:center;">
                    ...
                    <a href="<?php echo CController::createUrl('/catalogo/buscar', array('busqueda' => 'atacadol')) ?>" data-ajax="false"><img width="34" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/metamucil/ico-filtro.png" ></a>
                </section>
                <div class="space"></div>
                <section class="filtro-m" style="text-align:center;">
        ...
        <div class="row background">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-6 filtro" style="padding-top: 15px !important;padding-bottom: 15px !important;margin-top: 25px;">
                    <div class="col-md-7">
                        <span style="color:#E90000;">Productos relacionados</span>
                        <a href="<?php echo CController::createUrl('/catalogo/buscar', array('busqueda' => 'atacadol')) ?>"><img width="34" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/metamucil/ico-filtro.png" ></a>
                    </div>
                    <div class="col-md-5">
                        <span style="color:#E90000;">Más información</span>
                        <a href=""><img width="34" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/metamucil/ico-filtro.png" ></a>
