<?php $this->pageTitle = "Sampoo Pantene fuerza y reconstrucción | La Rebaja Virtual"; ?>
<?php
$this->metaTags = "
<meta http-equiv='X-UA-Compatible' content='IE=edge'>
<meta name='description' content='El Nuevo Shampoo Fuerza y Reconstrucción de Pantene con Pro-Vitaminas fortalece tu Cabello de manera efectiva y duradera donde más lo necesita. ¡Conócelo!'>
<meta name='keywords' content='Shampoo pantene restauración, shampoo para el cabello maltratado, shampoo pantene.'>
  <style>
...
<img class="img-responsive-m" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/pantene/banner-shampoo-mobile.jpg" alt="Shampoo pantene, cabello hasta 10 veces más fuerte">
<div class="marco-principal gradient-mobile" style="margin: 45px 0 0;border: none;padding: 0 37px 25px;font-size: 15px;">
  <fieldset class="ui-grid-a">
  	<div class="ui-block-a">
  	  <p style="font-size: 30px;margin-left: 70px;" class="nombre-vertical" style="margin-top: 30px;">SHAMPOO</p>
  	</div>
  	<div class="ui-block-b">
      <img  style="width: 110px;" class="img-responsive-m" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/pantene/shampoo-pantene.png " alt="Shampoo pantene">
  	</div>
  </fieldset>
  <p>Limpia y elimina los residuos. <br>
  Dejando el cabello suave y manejable. </p>
  <h4 class="beneficios">Beneficios</h4>
    <ul>
      <li>Cabello hasta 10 veces más Fuerte***.</li>
      <li>Penetra* y ayuda a fortalecer** hasta las puntas.</li>
      <li>Tiene tecnología inteligente que actúa donde el cabello más lo necesita.</li>
...
<?php else: ?>
<!--Versión escritorio-->
<img class="img-responsive" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/pantene/banner-shampoo.jpg" alt="Shampoo Pantene, cabello hasta 10 veces más fuerte">
<div class="container">
<div class="row marco-principal">
  <div class="col-md-4">
    <div class="col-sm-3">
      <p class="nombre-vertical">SHAMPOO</p>
    </div>
    <div class="col-sm-9">
      <img class="img-responsive producto" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/pantene/shampoo-pantene.png " alt="Shampoo pantene">
    </div>
  </div>
  <div class="col-md-8">
    ...
    <div class="row">
      <div class="col-sm-8">
        <p class="reference">*Usando Sistema Pantene **Fuerza contra el daño mecánico ***Fuerza contra <br>
        el daño mecánico vs. Shampoo sin ingredientes acondicionadores.<br>
         [Cálculo de P&amp;G basado en data de ventas de Julio 2015 a Junio 2016]</p>
      </div>
      <div class="col-sm-4">
