	...
	<div class="item" style="padding: 0 20px;">
	    ...
	    <div class="contenedor-info" style="border: 4px solid #0E1D60;padding: 15px;">
			...
			<center>
				...
				<a data-ajax="false" href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 92332 )) ?>"><img class="btn-comprar" style="margin: 20px 0;width: 70%;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/desknza/btn-comprar.png" alt=""></a>
			</center>
	    </div>
	</div>
	<div class="item" style="padding: 0 20px;">
	    ...
	    <div class="contenedor-info" style="border: 4px solid #0E1D60;padding: 15px;">
			...
			<center>
				...
				<a data-ajax="false" href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 92329 )) ?>"><img class="btn-comprar" style="margin: 20px 0;width: 70%;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/desknza/btn-comprar.png" alt=""></a>
			</center>
	    </div>
	</div>
	<div class="item" style="padding: 0 20px;">
	    ...
	    <div class="contenedor-info" style="border: 4px solid #0E1D60;padding: 15px;">
			...
			<center>
				...
				<a data-ajax="false" href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 25099 )) ?>"><img class="btn-comprar" style="margin: 20px 0;width: 70%;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/desknza/btn-comprar.png" alt=""></a>
			</center>
	    </div>
	</div>
	<div class="item" style="padding: 0 20px;">
	    ...
	    <div class="contenedor-info" style="border: 4px solid #0E1D60;padding: 15px;">
			...
			<center>
				...
				<a data-ajax="false" href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 115449 )) ?>"><img class="btn-comprar" style="margin: 20px 0;width: 70%;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/desknza/btn-comprar.png" alt=""></a>
			</center>
	    </div>
	</div>
	<div class="item" style="padding: 0 20px;">
	    ...
	    <div class="contenedor-info" style="border: 4px solid #0E1D60;padding: 15px;">
			...
			<center>
				...
				<a data-ajax="false" href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 105138 )) ?>"><img class="btn-comprar" style="margin: 20px 0;width: 70%;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/desknza/btn-comprar.png" alt=""></a>
			</center>
	    </div>
	</div>
</div>
        ...
        <p>cuenta con una tecnología de <span>MICROPERLAS ULTRA ANATÓMICAS QUE AYUDAN</span> <br> a relajar los músculos del cuerpo, devolviéndole la sensación de vivir cómodamente.</p>
	      <div class="contenedor-product">
	      	...
	      	<div class="beneficios">
				...
				<p class="precioproductos-antes">ANTES: <?= ($cervical == null) ? "--" : Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], $cervical["u-a"], Yii::app()->params->formatoMoneda['moneda']) ?> </p>
				<p class="precioproductos">AHORA: <?= ($cervical == null) ? "--" : Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], $cervical["u"], Yii::app()->params->formatoMoneda['moneda']) ?> </p>
				<a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 92332 )) ?>"><img class="btn-comprar" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/desknza/btn-comprar.png" alt=""></a>
	      	</div>
	      </div>
    </div>
        ...
        <p>cuenta con una tecnología de <span>MICROPERLAS ULTRA ANATÓMICAS QUE AYUDAN</span> <br>a relajar los músculos del cuerpo, devolviéndole la sensación de vivir cómodamente.</p>
	      <div class="contenedor-product">
	      	...
	      	<div class="beneficios">
				...
				<p class="precioproductos-antes">ANTES: <?= ($coccix == null) ? "--" : Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], $coccix["u-a"], Yii::app()->params->formatoMoneda['moneda']) ?></p>
				<p class="precioproductos">AHORA: <?= ($coccix == null) ? "--" : Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], $coccix["u"], Yii::app()->params->formatoMoneda['moneda']) ?></p>
				<a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 92329 )) ?>"><img class="btn-comprar" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/desknza/btn-comprar.png" alt=""></a>
	      	</div>
	      </div>
    </div>
        ...
        <p>cuenta con una tecnología de <span>MICROPERLAS ULTRA ANATÓMICAS QUE AYUDAN</span> <br>a relajar los músculos del cuerpo, devolviéndole la sensación de vivir cómodamente.</p>
	      <div class="contenedor-product">
	      	...
	      	<div class="beneficios">
				...
				<p class="precioproductos-antes">ANTES: <?= ($lumbar == null) ? "--" : Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], $lumbar["u-a"], Yii::app()->params->formatoMoneda['moneda']) ?> </p>
				<p class="precioproductos">AHORA: <?= ($lumbar == null) ? "--" : Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], $lumbar["u"], Yii::app()->params->formatoMoneda['moneda']) ?> </p>
				<a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 25099 )) ?>"><img class="btn-comprar" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/desknza/btn-comprar.png" alt=""></a>
	      	</div>
	      </div>
    </div>
        ...
        <p>cuenta con una tecnología de <span>MICROPERLAS ULTRA ANATÓMICAS QUE AYUDAN</span> <br>a relajar los músculos del cuerpo, devolviéndole la sensación de vivir cómodamente.</p>
	      <div class="contenedor-product">
	      	...
	      	<div class="beneficios">
				...
				<p class="precioproductos-antes">ANTES: <?= ($cervical_mundo_animal == null) ? "--" : Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], $cervical_mundo_animal["u-a"], Yii::app()->params->formatoMoneda['moneda']) ?>  </p>
				<p class="precioproductos">AHORA: <?= ($cervical_mundo_animal == null) ? "--" : Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], $cervical_mundo_animal["u"], Yii::app()->params->formatoMoneda['moneda']) ?> </p>
				<a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 115449 )) ?>"><img class="btn-comprar" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/desknza/btn-comprar.png" alt=""></a>
	      	</div>
	      </div>
    </div>
        ...
        <p>cuenta con una tecnología de <span>MICROPERLAS ULTRA ANATÓMICAS QUE AYUDAN</span> <br>a relajar los músculos del cuerpo, devolviéndole la sensación de vivir cómodamente.</p>
	      <div class="contenedor-product">
	      	...
	      	<div class="beneficios">
				...
				<p class="precioproductos-antes">ANTES:  <?= ($cervical_infantil == null) ? "--" : Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], $cervical_infantil["u-a"], Yii::app()->params->formatoMoneda['moneda']) ?></p>
				<p class="precioproductos">AHORA: <?= ($cervical_infantil == null) ? "--" : Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], $cervical_infantil["u"], Yii::app()->params->formatoMoneda['moneda']) ?> </p>
				<a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 105138 )) ?>"><img class="btn-comprar" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/desknza/btn-comprar.png" alt=""></a>
	      	</div>
	      </div>
    </div>
