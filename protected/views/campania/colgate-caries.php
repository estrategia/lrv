...
<h1 class="title-intro" style="font-size: 20px;">OFREZCA A SUS PACIENTES <br>UN régimen <br>
<span style="font-size: 17px;">PARA AYUDAR A PREVENIR <br> LA CARIES DENTAL </span></h1>
...
<ul class="beneficios" style="padding-inline-start: 40px;" >
  <li>Reduce la placa en los lugares en <br> donde el cepillo de dientes no llega.</li>
</ul>
...
<div class="container">
  <div class="row">
    <h1 class="title-intro">OFREZCA A SUS PACIENTES UN régimen <br>
    <span>PARA AYUDAR A PREVENIR LA CARIES DENTAL</span></h1>
  </div>
  <div class="row">
    ...
    <div class="column col-sm-4 col-md-4">
      <img class="img-responsive producto" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/colgate/4-prevencion-caries/colgate-plax-soft.png" alt="Colgate Plax soft">
      ...
      <ul class="beneficios" style="padding-inline-start: 83px;margin-bottom: 76px;">
        <li style="margin-bottom: 10px;"> Reduce la placa en los lugares en <br> donde el cepillo de dientes no llega.</li>
        <p >&nbsp; </p>
      </ul>
    </div>
    <div class="column col-sm-4 col-md-4">
      <img class="img-responsive producto" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/colgate/4-prevencion-caries/colgate-360-interdental.png" alt="Colgate 360 interdental">
      <h2 class="nombre-producto">CEPILLO DE DIENTES</h2>
      <h3 class="componente">COLGATE<sup>®</sup> 360<sup>°</sup> INTERDENTAL <br> &nbsp;</h3>
