<?php $this->pageTitle = "Eucerin infantil - La Rebaja Virtual"; ?>
<?php
$this->metaTags = "
  <meta http-equiv='X-UA-Compatible' content='IE=edge'>
  <meta name='description' content='Eucerin Sun Protection ofrece una loción solar de protección muy alta frente a los rayos UV, idónea para niños mayores de 1 año.'>
  <meta name='keywords' content='eucerin, eucerin protector solar, productos eucerin.'>
	<style>
...
<div class="menu" style="margin-top: 30px;">
    <a href="<?= Yii::app()->request->baseUrl ?>/eucerin-proteccion-solar-facial"><div class="item" style="border-bottom:2px solid #fff;">facial </div></a>
    <a href="<?= Yii::app()->request->baseUrl ?>/eucerin-proteccion-solar-corporal"><div class="item">corporal </div></a>
    <a href="<?= Yii::app()->request->baseUrl ?>/eucerin-proteccion-solar-infantil"><div class="item active">kids </div></a>
</div>
<div class="bg-product" style="padding: 15px 30px;">
    <h3 class="name-product" style="font-size: 19px;">SUN KIDS 150ml</h3>
    <img class="figure-m" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/eucerin/arrow.png">
    <ul class="lista">
      <li>Aerosol solar de protección muy alta <br> frente a los rayos UV.</li>
      <li>Idóneo para niños mayores de 1 año. </li>
      <li>De fácil aplicación, no graso y resistente al agua.</li>
    </ul>
    <img class="img-responsive-m" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/eucerin/kids.png" alt="Sun kids">
    <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' =>82601)) ?>"><img style="width: 70%;margin: 0 auto;display: block;"  src="<?= Yii::app()->request->baseUrl ?>/images/contenido/eucerin/compra-online.png" alt="Compra online"></a>
</div>
<div class="video">
...
<div class="container" style="padding: 0 10%;">
  ...
  <div class="row menu">
    ...
    <a href="<?= Yii::app()->request->baseUrl ?>/eucerin-proteccion-solar-infantil"><div class="col-sm-4 col-md-4 item active">kids </div></a>
  </div>
  <div class="row bg-product" style="margin-bottom:0px;">
    <div class="col-sm-7 col-md-7">
      <h3 class="name-product">SUN KIDS 150ml</h3>
    ...
    <div class="col-sm-5 col-md-5">
      <img class="img-responsive" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/eucerin/kids.png" alt="Sun kids">
      <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' =>82601)) ?>"><img style="width: 80%;margin: 0 auto;display: block;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/eucerin/compra-online.png" alt="Compra online"></a>
    </div>
  </div>
