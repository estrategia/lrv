<?php $this->pageTitle = "Cuidado en casa - Rehabilitación y recuperación | La Rebaja Virtual"; ?>
<?php
$this->metaTags = "
  ...
  <style>
    ...
    .bg-color {font-family:Campton-Book;background-color: #FFB998;text-align: center;color: #3F3730;font-size: 16px;padding: 25px;margin: 15px;}
...
<img class="img-responsive-m" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cuidado-en-casa/banner/08-banner-rehabilitacion.jpg" alt="Rehabilitacion">
<div class="content-banner" style="margin: -10px 25px;">
  ...
  <img width="320"  style="margin-top: 15px;margin-bottom: 15px;"src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cuidado-en-casa/banner/08-rehabilitacion-y-recuperacion.jpg" alt="Rehabilitacion y recuperacion">
  <p style="text-align: center;margin-top: 0px;margin-bottom: 30px;">​Cuidado pos quirúrgico y elementos<br>que te ayudan a mejorar.</p>
</div>
<section class="row bg-color" style="margin: 0 0 20px;">
  Ahora en La Rebaja, tenemos a tu disposición 4 líneas de productos especializados para el cuidado pos quirúrgico y
...
<div class="roll-back-m">
  <a data-ajax="false" href="<?= Yii::app()->request->baseUrl ?>/cuidado-en-casa" style="color: #3F3730;">
    <p style="font-family: Campton-SemiBold;"><span>Volver a las <br> categorías <br> principales</span></p>
  </a>
</div>
...
<div class="row">
  <div class="col-sm-5 col-md-5">
    <div class="content-banner">
      ...
      <img class="img-responsive" width="500" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cuidado-en-casa/banner/08-rehabilitacion-y-recuperacion.jpg" alt="rehabilitacion-y-recuperacion">
      <p>Cuidado pos quirúrgico y elementos<br>que te ayudan a mejorar.</p>
    </div>
  </div>
  <div class="col-sm-7 col-md-7">
    <img class="img-responsive" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cuidado-en-casa/banner/08-banner-rehabilitacion.jpg" alt="rehabilitacion-y-recuperacion">
  </div>
</div>
    ...
    <div class="col-md-12">
      <div class="roll-back">
        <a href="<?= Yii::app()->request->baseUrl ?>/cuidado-en-casa" style="color: #3F3730;">
          <p><span>Volver a las categorías principales</span></p>
        </a>
      </div>
    </div>
  </div>
