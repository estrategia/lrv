<?php $this->pageTitle = "Cuidado en casa - Confort | La Rebaja Virtual"; ?>
<?php
$this->metaTags = "
  ...
  <style>
    ...
    .bg-color {font-family:Campton-Book;background-color: #A6E1EE;text-align: center;color: #3F3730;font-size: 16px;padding: 25px;margin: 15px;}
    ...
    .roll-back-m {background-color: #F1F0EE;color: #3F3730;border-radius: 25px;padding: 25px 0px;height:218px;}
...
<img class="img-responsive-m" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cuidado-en-casa/banner/04-banner-confort.jpg" alt="Confort">
<div class="content-banner" style="margin: -10px 25px;">
  ...
  <img width="225" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cuidado-en-casa/banner/04-confort.jpg" alt="Confort">
  <p style="text-align: center;margin-top: -5px;margin-bottom: 30px;">Las mejores alternativas para  <br> u​n​ ​buen ​descanso​​.</p>
</div>
<section class="row bg-color" style="margin: 0 0 20px;">
  Encuentra en La Rebaja una variedad de artículos ​especializados para ​lograr una máxima relajación en cualquier momento del día.
...
<div class="row">
  <div class="col-sm-5 col-md-5">
    <div class="content-banner">
      ...
      <img class="img-responsive" width="265" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cuidado-en-casa/banner/04-confort.jpg" alt="Confort">
      <p>Las mejores alternativas para  <br> u​n​ ​buen ​descanso​​.</p>
    </div>
  </div>
  <div class="col-sm-7 col-md-7">
    <img class="img-responsive" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cuidado-en-casa/banner/04-banner-confort.jpg" alt="Confort">
  </div>
</div>
