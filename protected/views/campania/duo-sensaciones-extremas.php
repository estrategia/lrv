<?php $this->pageTitle = "Condones DUO Sesaciones extremas - La Rebaja Virtual"; ?>
<?php
...
<div class="container bg-gray">
  <div class="row">
    <div style="padding: 0 15px;margin-bottom: 15px;margin-top: -5px;">
      ...
      <a href="<?= Yii::app()->request->baseUrl ?>/condones-duo-sensaciones-extremas" data-ajax="false">
        <span class="item-menu active" style="margin-top: -5px;">SENSACIONES EXTREMAS</span>
      </a>
    </div>
  ...
  <div class="colum-white">
    ...
    <img class="img-responsive producto-m" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/duo/sensaciones-extremas/g-vibration.png">
    <div class="colum-black" style="margin-left: -1px;">
      <h2 class="name-product" style="font-size: 42px;">DUO G-VIBRATION</h2>
      <p class="descrip-product">Un anillo vibrador que la estimula en el punto exacto, Prepárate para sincronizar el momento y llenarla de placer.</p>
        <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 53276)) ?>" data-ajax="false"><img class="img-responsive-m " src="<?= Yii::app()->request->baseUrl ?>/images/contenido/duo/sensaciones-extremas/compra-g-vibration.png"></a>
    </div>
  </div>
  <div style="height:70px;"></div>
  <div class="colum-white">
    <img class="img-responsive new-image" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/duo/nueva-imagen.png">
    <img class="img-responsive producto-m" style="margin: 0px 3px auto;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/duo/sensaciones-extremas/pure-gel-lubricante.png">
    <div class="colum-black" style="margin-left: -1px;">
  ...
  <div class="container bg-gray">
    <div class="row">
      <div class="col-sm-4 col-md-4" style="padding: 0 25px;">
        ...
        <a href="<?= Yii::app()->request->baseUrl ?>/condones-duo-sensaciones-extremas">
          <span class="item-menu active">SENSACIONES EXTREMAS</span>
        </a>
      </div>
      <div class="col-sm-4 col-md-4" style="padding: 0 25px;">
    ...
    <div class="row colum-white">
      <div class="col-sm-6 col-md-6">
        <img class="img-responsive new-image" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/duo/nueva-imagen.png">
        <img class="img-responsive producto" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/duo/sensaciones-extremas/g-vibration.png">
      </div>
      <div class="col-sm-6 col-md-6 colum-black">
        <h2 class="name-product">DUO G-VIBRATION</h2>
        <p class="descrip-product">Un anillo vibrador que la estimula en el punto exacto, Prepárate para sincronizar el momento y llenarla de placer.</p>
      <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 53276)) ?>"><img class="img-responsive btn-comprar" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/duo/sensaciones-extremas/compra-g-vibration.png"></a>
      </div>
    </div>
    ...
    <div class="row colum-white">
      <div class="col-sm-6 col-md-6">
        <img class="img-responsive new-image" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/duo/nueva-imagen.png">
        <img class="img-responsive producto" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/duo/sensaciones-extremas/pure-gel-lubricante.png">
      </div>
      <div class="col-sm-6 col-md-6 colum-black">
