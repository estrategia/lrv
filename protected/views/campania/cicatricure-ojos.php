<?php $this->pageTitle = "Cicatricure contorno de ojos - La Rebaja Virtual"; ?>
<?php
$this->metaTags = "<meta http-equiv='X-UA-Compatible' content='IE=edge'>
  ...
  <meta name='keywords' content='cicatricure, cicatricure gel, cicatricure beauty care.'>
    ...
    .main-title::after {content: '';height: 2px;width: 270px;margin-top: 25px;background-color:#E91D7B;display: block;margin: 5px auto;}
...
<div class="header">
  ...
  <h1 class="main-title" style="padding: 0 15px;font-size: 25px;">¿Tienes ojeras?</h1>
  <img class="img-responsive-m"  style="margin-top: -5px;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cicatricure/banner-contorno-ojos.jpg">
  <div class="parrafo animate1 wow zoomIn" data-wow-offset="100" style="padding:0 15px;">
    <p>Algunas líneas de expresión alrededor de los ojos pueden empezar a generarse, incluso antes de los 30 años, ya que se <br>
    trata de una de las zonas más expresivas del cuerpo. Cuidándote adecuadamente puedes prevenirlas y ayudar a <br>
    mejorar la apariencia de las que ya existen.</p>
  </div>
  ...
  <div style="background-color:#e91d7b;margin-top: 60px;padding: 20px;">
    <img class="img-responsive-m" style="margin: 15px 0 30px;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cicatricure/contorno-ojos.png">
    <a style="margin-top: -15px;text-decoration: none;" href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 68091)) ?>" class="comprar-large">COMPRAR</a>
    <h3 class="title-white" style="margin-top:50px;">CICATRICURE CONTORNO DE OJOS</h3>
    <p class="text-white">Protege tu mirada <br>
    Con Cicatricure Contorno de Ojos empieza a ver el futuro con ojos de juventud. <br>
    ...
    <div style="background-color:#fff;text-align: center;color:#E91D7B;padding: 5px 15px;">
      <img class="img-responsive" style="margin: 0 auto;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cicatricure/reloj-rosado.jpg">
      <p>Aplicar por la mañana y la noche sobre la piel seca y limpia.</p>
      <img class="img-responsive"  style="margin: 0 auto;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cicatricure/contorno.jpg">
      <p>Aplicar sobre los<br>párpados superiores e<br>inferiores, así como en la<br>comisura de los ojos.</p>
      <img class="img-responsive"  style="margin: 0 auto;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cicatricure/masaje.jpg">
      <p>Dar un ligero masaje en<br>forma circular con<br>suaves golpeteos con<br>la yema de los dedos.</p>
    </div>
  </div>
...
<h1 class="main-title">¿Tienes ojeras?</h1>
<img class="img-responsive"  style="margin-top: -5px;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cicatricure/banner-contorno-ojos.jpg">
<div class="container">
...
<div class="row" style="background-color:#e91d7b;margin-top: 60px;padding: 20px;">
  ...
  <div class="col-sm-7 col-md-7">
    <div class="row">
      <h3 class="title-white">CICATRICURE CONTORNO DE OJOS</h3>
      <p class="text-white">Protege tu mirada <br>
      Con Cicatricure Contorno de Ojos empieza a ver el futuro con ojos de juventud. <br>
      Está especialmente formulado para proteger e hidratar la delicada piel que rodea los ojos.  Su exclusiva formula disminuye la profundidad de las arrugas y  reduce notoriamente el nivel de pigmentación de  las ojeras.
      </p>
