...
<div class="pattern" style="padding: 0 15px;">
  ...
  <ul class="content-table" style="background-color:#93AD25;padding-inline-start: 45px;margin-top: 5px;">
    ...
    <li>&Aacute;cido Fólico &#8226; Selenio</li>
  </ul>
  ...
  <ul class="content-table" style="background-color:#E20612;padding-inline-start: 45px;margin-top: 5px;">
    <li style="padding-top: 12px;">Contiene &Aacute;cido Alfa Linolénico</li>
    <li>&Aacute;cido Linolénico</li>
  </ul>
  <center>
    <h3 style="font-family: Gotham-Rounded-Medium;color: #0E4190;border-bottom: 2px solid #0E4190;display: inline-block;margin: 45px auto 20px;">CONOCE M&Aacute;S</h3>
