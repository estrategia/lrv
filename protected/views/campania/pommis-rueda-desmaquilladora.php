<?php $this->pageTitle = "Todo tipo de piel - La Rebaja Virtual"; ?>
<?php
...
'>
  ...
  <style>
    ...
    .bg-product {background-image: url(".Yii::app()->request->baseUrl."/images/contenido/pomys/todo-tipo-de-piel/fondo-producto-naranja.png);background-size: cover;}
    ...
    .image-container-seca {display:block;width: 100%;height:100%;background: url(".Yii::app()->request->baseUrl."/images/contenido/pomys/normal-a-seca/item-menu.png),url(".Yii::app()->request->baseUrl."/images/contenido/pomys/normal-a-seca/item-menu-hover.png);background-size:100% 100%, 0% 0%;}
    .image-container-seca:hover {background-size: 0% 0%, 100% 100% ;}
    .image-container-all {display:block;width: 100%;height:100%;background: url(".Yii::app()->request->baseUrl."/images/contenido/pomys/todo-tipo-de-piel/item-menu.png),url(".Yii::app()->request->baseUrl."/images/contenido/pomys/todo-tipo-de-piel/item-menu-hover.png);background-size: 0% 0%, 100% 100%;}
    .image-container-all:hover {background-size: 100% 100%, 0% 0%;}
    ...
    .line-dotted {border-bottom: 6px dotted #FF9100;width: 52%;display: block;margin-bottom: 20px;}
    ...
    .bg-round {margin-top: -2px;background-image: url(".Yii::app()->request->baseUrl."/images/contenido/pomys/todo-tipo-de-piel/bg-round.png);background-size: 100% 100%;}
    .hide {display:none !important;-webkit-transition: width 2s linear; transition: width 2s linear;}
    .container.padding {padding: 0 5%;}
    .nombre-producto {color: #FF9100;font-family: signika-negative-semibold;}
    .space {height: 35px;}
    ...
    .title-bullet{line-height: 33px;margin-left:5px;margin-top: 35px;color: #fff;font-family: signika-negative-semibold;font-size: 35px;text-shadow: 2px 2px #4c4c4c66;}
    .ico-rose {width: 27px;height: 27px;margin-top: 24px;}
    .descrip {margin-top: 10px;font-family: signika-negative;color: #fff;margin-left: 33px;font-size: 20px;}
  ...
  <div class="pattern">
    <div style="padding:0 15%;">
      ...
      <a data-ajax="false" href="<?= Yii::app()->request->baseUrl ?>/pomys-toallas-desmaquilladoras-piel-seca">
        <img class="img-responsive-m" style="margin-bottom:15px;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/pomys/normal-a-seca/item-menu.png">
      </a>
      <a data-ajax="false" href="<?= Yii::app()->request->baseUrl ?>/pomys-rueditas-desmaquilladoras">
        <img class="img-responsive-m" style="margin-bottom:15px;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/pomys/todo-tipo-de-piel/item-menu-hover.png">
      </a>
    </div>
    <div style="margin-top: 50px;padding:0 8%;">
      <h2 class="nombre-producto" style="margin: 5px;">Rueditas desmaquilladoras<br> todo tipo de piel</h2>
      <span class="line-dotted"></span>
      <div class="flex-container">
        <img src="<?= Yii::app()->request->baseUrl ?>/images/contenido/pomys/todo-tipo-de-piel/icono-bullet.png">
        <span> No se deshacen ni sueltan pelusa, permitiendo una limpieza <br> más eficaz y suave con tu piel.</span>
      </div>
      <div class="flex-container" style="margin-top:20px;">
        <img src="<?= Yii::app()->request->baseUrl ?>/images/contenido/pomys/todo-tipo-de-piel/icono-bullet.png">
        <span> Usalas para: <br>
          <span style="font-family: signika-negative;">Aplicar el maquillaje.</span><br>
          <span style="font-family: signika-negative;">Remover el maquillaje.</span><br>
    ...
    <div style="background-color: rgba(156, 36, 141, 0.4);border-bottom: 5px solid #ADACAC;">
      <div class="container padding">
        <div class="row" style="margin-bottom: 15px;">
            ...
            <div style="display:flex;">
              ...
              <span class="title-bullet" style="margin-top: 43px;font-size: 22px;margin-left: 8px;line-height: 11px;">Toallitas Húmedas <br> Desmaquilladoras Pomys<sup>&reg;</sup></span>
            </div>
            <p class="descrip" style="font-size: 18px;margin-top: 20px;">No dejan sensación grasosa <br> No requieren enjuague</p>
            <a data-ajax="false" href="<?= Yii::app()->request->baseUrl ?>/pomys-toallas-desmaquilladoras-piel-mixta">
              <img style="width: 55%;margin: 30px auto;display:block;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/pomys/click-aqui.png">
            </a>
            <img class="producto-rueditas" style="margin: 0 auto;display: block;width: 90%;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/pomys/todo-tipo-de-piel/producto-banner-secundario.png" alt="Toallitas humedas desmaquilladoras">
        </div>
      </div>
    </div>
    ...
    <div class="container padding">
      <div class="row" style="margin-bottom: 80px;">
        <div class="col-sm-6 col-md-6">
          ...
          <div style="display:flex;">
            <img class="ico-rose" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/pomys/mixta-a-grasa/icon-white.png">
            <span class="title-bullet">Toallitas Húmedas <br> Desmaquilladoras Pomys <sup>&reg;</sup></span>
          </div>
          <p class="descrip">No dejan sensación grasosa - No requieren enjuague</p>
          <a href="<?= Yii::app()->request->baseUrl ?>/pomys-toallas-desmaquilladoras-piel-mixta">
            <img style="width: 45%;margin: 30px auto;display:block;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/pomys/click-aqui.png">
          </a>
        </div>
        <div class="col-sm-6 col-md-6">
          <img class="img-responsive" style="margin-top: 12%;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/pomys/todo-tipo-de-piel/producto-banner-secundario.png" alt="Toallitas humedas desmaquilladoras">
        </div>
      </div>
    </div>
  </div>
