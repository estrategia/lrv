<?php $this->pageTitle = "Cuidado en casa - Equipos para profesionales | La Rebaja Virtual"; ?>
<?php
$this->metaTags = "
  ...
  <style>
    ...
    .bg-color {font-family:Campton-Book;background-color: #CEDCB4;text-align: center;color: #3F3730;font-size: 16px;padding: 25px;margin: 15px;}
    ...
    .roll-back-m {background-color: #F1F0EE;color: #3F3730;border-radius: 25px;padding: 25px 0px;height:217px;}
...
<img class="img-responsive-m" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cuidado-en-casa/banner/06-banner-equipos-para-profesionales.jpg" alt="Equipos para profesionales">
<div class="content-banner" style="margin: -10px 25px;">
  ...
  <img width="320" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cuidado-en-casa/banner/06-equipos-para-profesionales.jpg" alt="Equipos para profesionales">
  <p style="text-align: center;margin-top: 0px;margin-bottom: 30px;">Seguridad y responsabilidad para<br>el personal de la salud.</p>
</div>
<section class="row bg-color" style="margin: 0 0 20px;">
  ​En La Rebaja ofrecemos una línea de productos para garantizar ​respaldo y bienestar en las situaciones de vulnerabilidad al contagio de infecciones que ponen en riesgo tu salud y la de tus pacientes.
</section>
<div class="ui-grid-a line-categories" style="padding: 0 15px;">
    ...
    <div class="border-m">
      <a data-ajax="false" href="<?php echo CController::createUrl('/contenido/ver', array('tipo' => 'grupo', 'contenido' => 5114)) ?>"><img class="img-responsive-m"  style="width: 100%;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cuidado-en-casa/productos/instrumentos-diagnosticos.png" alt="Instrumentos diagnosticos"></a>
      <p style="font-size: 18px;"><span>Instrumentos <br> de diagnósticos</span></p>
      <a data-ajax="false" href="<?php echo CController::createUrl('/contenido/ver', array('tipo' => 'grupo', 'contenido' => 5114)) ?>"><img class="img-responsive-m" style="width: 100%;"  src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cuidado-en-casa/referencias.jpg" alt=""></a>
    </div>
  </div>
</div>
...
<div class="row">
  <div class="col-sm-5 col-md-5">
    <div class="content-banner">
      ...
      <img class="img-responsive" width="500" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cuidado-en-casa/banner/06-equipos-para-profesionales.jpg" alt="Equipos para profesionales">
      <p> Seguridad y responsabilidad para<br>el personal de la salud.</p>
    </div>
  </div>
  <div class="col-sm-7 col-md-7">
    <img class="img-responsive" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cuidado-en-casa/banner/06-banner-equipos-para-profesionales.jpg" alt="Equipos para profesionales">
  </div>
</div>
...
<div class="container">
  <div class="row line-categories" style="margin-bottom: 60px;margin-top:25px;">
    ...
    <div class="col-sm-3 col-md-3">
      <div class="border">
        <a href="<?php echo CController::createUrl('/contenido/ver', array('tipo' => 'grupo', 'contenido' => 5114)) ?>"><img class="img-responsive" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cuidado-en-casa/productos/instrumentos-diagnosticos.png" alt="Instrumentos diagnosticos"></a>
        <p><span>Instrumentos <br> de diagnósticos</span></p>
        <a href="<?php echo CController::createUrl('/contenido/ver', array('tipo' => 'grupo', 'contenido' => 5114)) ?>"><img class="img-responsive" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/cuidado-en-casa/referencias.jpg" alt=""></a>
      </div>
    </div>
  </div>
</div>
