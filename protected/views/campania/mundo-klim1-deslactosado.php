<?php $this->pageTitle = "Mundo Klim 1+ Deslactosado - La Rebaja Virtual"; ?>
<?php
  $this->metaTags = "
  ...
  <style>
    ...
    .main-bg {background: url(".Yii::app()->request->baseUrl."/images/contenido/mundo-klim/klim-deslactosado/main-bg.jpg) center no-repeat;background-size: cover;}
    .main-bg .corazon {background: url(".Yii::app()->request->baseUrl."/images/contenido/mundo-klim/klim-deslactosado/corazon.png) top right no-repeat;}
    .info-producto {padding: 30px 40px; background: #fff; border: 6px solid #A53B83; border-radius: 30px; display: flex; flex-direction: row; flex-wrap: wrap; justify-content: space-between; width: 100%; max-width: 1000px; margin: 80px auto 40px;}
    .info-producto .img-producto {width:40%;}
    .info-producto .txt-producto {width:60%;}
    .info-producto .img-producto img {width: 100%; margin: 40px auto 0; display: block;}
    ...
    .btn-compra-banner {width: 100%; max-width: 1300px; margin: -50px auto 0; position: relative;}
    .btn-compra-banner img {width: 190px; max-width: 190px; position: absolute;right: 0;}
    .txt-producto .title-producto {font-family: VAGRoundedStd-Bold; color: #A53B83; margin-top: 25px; margin-bottom: 0px; font-size: 40px;}
    .txt-producto .subtitle-producto{ margin-bottom: 25px !important; color:#E545B3; font-family: VAGRoundedStd-Bold; margin: 0; font-size: 21px;}
    .main-txt {font-family: VAGRoundedStd-Thin; color: #515151; font-size: 21px; line-height: 24px; margin-bottom: 25px;}
    ...
    .txt-footer {text-align: center; font-family: VAGRoundedStd-Bold; color: #fff; margin:0; font-size: 17px;padding: 25px 0;}
    ...
    .bg-footer-m {background: url(".Yii::app()->request->baseUrl."/images/contenido/mundo-klim/klim-deslactosado/footer.png);background-size: 100%; background-repeat: no-repeat;}
    ...
    @media only screen and (max-width: 1920px) and (min-width: 1700px)  {
      .bg-footer {margin-top: -230px;}
      .title-footer {margin-top: 360px;}
...
<div class="main-bg" style="background-image: 100%;">
    <div class="corazon" style="background-size: 100px;">
      <img class="img-responsive-m" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/mundo-klim/klim-deslactosado/banner.png" alt="Nestle klim 1+ deslactosado">
      ...
      <div style="padding: 0 25px 0px 15px;">
        <section class="info-producto" style="flex-direction:column; padding: initial;">
          <div class="img-producto" style="width: 55%; margin: 0 auto;">
            <img src="<?= Yii::app()->request->baseUrl ?>/images/contenido/mundo-klim/klim-deslactosado/klim-deslactosado.png" alt="Comprar Klim fortiprotect">
          </div>
          <div class="txt-producto" style="width: 100%;">
            <h1 class="title-producto" style="font-size: 25px; text-align: center;">KLIM<sup>&reg;</sup> 1+ Deslactosado</h1>
            <h2 class="subtitle-producto" style="text-align: center;">NIÑOS DE 1 A 5 AÑOS CON INTOLERANCIA A LA LACTOSA</h2>
            <p class="main-txt" style="font-size: 18px; padding: 0 11px; text-align:center;margin: 5px 0;">Los síntomas más frecuentes asociados a la intolerancia
            a la lactosa en niños a partir de un año son inapetencia,
            dolor y/o hinchazón abdominal, flatulencias excesivas,
      ...
      <div class="video">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/rtLT3M09UP4?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
      </div>
      <h3 class="title-section-video" style="font-size: 30px; text-align: center; line-height: 15px;">Conoce todos los productos KLIM<sup>&reg;</sup> <br>
        <a data-ajax="false" style="text-decoration: none;" href="<?= Yii::app()->request->baseUrl ?>/mundo-klim"><span style="font-size: 20px; display: block; width: 76px; margin: 22px auto 0; padding: 10px 30px;">aquí</span></a>
      </h3>
      ...
      <div style="background-color:#A53B83; padding: 1px 0; margin-top: 25px;">
        <h3 class="title-footer" style="font-size: 24px; margin-top: 30px;">Conoce más beneficios de KLIM<sup>&reg;</sup> 1+ Deslactosado</h3>
        <img class="img-responsive-m" style="width: 80%; margin: 0 auto; display: block;" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/mundo-klim/klim-deslactosado/video.png">
        <div style="padding: 0 30px;">
          <p class="consulte">Consulte a su médico</p>
          <p class="legal-fot" style="text-align: left;">La leche materna es el mejor <span>Alimento para el niño.</span>
          <span>KLIM<sup>&reg;</sup> 1+ DESLACTOSADO</span> es un Alimento Lácteo
          complementario de la leche materna especialmente
          diseñado para niños de 1 año en adelante.</p>
          <p class="txt-footer" style="font-size: 12px; padding: 10px 0 30px;">Como parte de un estilo de vida saludable que incluye alimentación balanceada y actividad física regular</p>
        </div>
      </div>
    </div>
  </div>
...
<div class="main-bg">
  <div class="corazon">
    <img class="banner" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/mundo-klim/klim-deslactosado/banner.png" alt="Nestle klim 1+ deslactosado">
    ...
    <section class="info-producto">
      ...
      <div class="txt-producto">
        <h1 class="title-producto">KLIM<sup>&reg;</sup> 1+ Deslactosado</h1>
        <h2 class="subtitle-producto">NIÑOS DE 1 A 5 AÑOS CON INTOLERANCIA A LA LACTOSA</h2>
        <p class="main-txt">Los síntomas más frecuentes asociados a la intolerancia <br>
        a la lactosa en niños a partir de un año son inapetencia, <br>
        dolor y/o hinchazón abdominal, flatulencias excesivas, <br>
    ...
    <section class="content-products">
      <a href="#" class="bmd-modalButton"  data-toggle="modal" data-bmdSrc="https://www.youtube.com/embed/rtLT3M09UP4?rel=0&amp;showinfo=0" data-bmdWidth="800" data-bmdHeight="400" data-target="#myModal"  data-bmdVideoFullscreen="true">
        <img class="img-recetas" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/mundo-klim/klim-deslactosado/recetas.png" alt="Recetas Klim fortiprotect">
      </a>
    ...
    <div class="bg-footer">
        <section>
          ...
          <h3 class="title-footer">Conoce más beneficios de KLIM<sup>&reg;</sup> 1+ Deslactosado</h3>
          <div class="flex-footer">
            ...
            <div class="colum-img">
              <div class="video">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/MrThrOY_SRQ?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
              </div>
            </div>
            <div class="column-txt">
              <p class="legal-fot">La leche materna es el mejor <span>Alimento para el niño.</span> <br>
              <span>KLIM<sup>&reg;</sup> 1+ DESLACTOSADO</span> es un Alimento Lácteo <br>
              complementario de la leche materna especialmente <br>
              diseñado para niños de 1 año en adelante.</p>
            </div>
          </div>
