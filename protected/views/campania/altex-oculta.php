...
$this->metaTags = "<meta http-equiv='X-UA-Compatible' content='IE=edge'>
  ...
  <meta name='keywords' content='Altex, jabon altex, altex acné.'>
    ...
    .menu .active {background-position: 35px -344px;background-image: url(/lrv/images/contenido/altex/btn-menu.png);background-repeat: no-repeat;text-decoration:none;height: 154px;width: 100%;display: block;color:#fff;}
    ...
    .space {height:130px;}
    .lista {list-style: url(/lrv/images/contenido/altex/3-oculta/item-list.png) ;font-family:SohoGothicPro-Regular ;font-size:20px;margin: 35px auto;}
