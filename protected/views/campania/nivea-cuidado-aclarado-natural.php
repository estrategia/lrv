<?php $this->pageTitle = "Nivea Aclarado Natural | La Rebaja Virtual"; ?>
<?php
$this->metaTags = "
...
<section class="bg-intro" style="padding: 20px 0 30px;margin-top: -5px;">
  ...
  <div class="intro" style="flex-direction: column;padding: 0 20px 0;">
    <div class="descripcion-producto" style="width: 100%;">
      <h1 class="titulo-principal" style="text-align: center;">NIVEA CUIDADO<span> <br> ACLARADO NATURAL  </span></h1>
      <h2 class="sub-title" style="text-align: center;">PIEL UNIFORME E <br>INTENSAMENTE HIDRATADA.</h2>
      <p class="intro-texto" style="font-size: 14px;">Hidratación intensiva sin sensación grasosa en el rostro, además ayuda a prevenir manchas y unificar el tono de tu piel.</p>
...
<section class="bg-intro">
  ...
  <div class="intro">
    ...
    <div class="descripcion-producto">
      <h1 class="titulo-principal">NIVEA CUIDADO<span> ACLARADO NATURAL </span></h1>
      <h2 class="sub-title">PIEL UNIFORME E INTENSAMENTE HIDRATADA.</h2>
      <p class="intro-texto">Hidratación intensiva sin sensación grasosa en el rostro, además <br>
      ayuda a prevenir manchas y unificar el tono de tu piel.</p>
      <ul class="lista">
        <li><span>Ayuda a aclarar y unificar el tono de la piel* </span>  <br>
          *Después de 2 semanas de uso regular. <br>
          Basado en estudio hecho en Alemania, 2013.
        ...
        <li><span>Contiene Vitamina C y FPS 15</span></li>
        <li><span>Sin sensación grasosa*** </span> <br>
          ***Basado en estudio de percepción hecho en México.
        </li>
        <li><span>Tamaños disponibles: 50 ml, 100 ml.</span></li>
