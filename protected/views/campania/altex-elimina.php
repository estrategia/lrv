...
<?php if ($this->isMobile): ?>
  <img class="img-responsive-m" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/altex/banner-elimina.png">
...
<div class="background">
  <div class="container">
    <img class="img-responsive" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/altex/banner-elimina.png">
