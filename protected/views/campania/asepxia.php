...
/*
.agua{background-size: cover;position: absolute;width: 100%;height: 100%;margin-top: 3%;opacity: 0.8;
    background-image:url(".Yii::app()->request->baseUrl."/images/contenido/asepxia/images/water-bubbles.png);}
@media (max-width: 900px) {.agua{background-size: 121%;position: absolute;width: 137%;height: 26%;margin-top: 43%;opacity: 0.8;
    background-image:url(".Yii::app()->request->baseUrl."/images/contenido/asepxia/images/water-bubbles.png);}}
    */
...
=======
p.precioproductos{font-family:Fjalla One;text-align: center;font-size: 1.6em;color: #4A4A4A;width: 300px;font-weight: bold;transform: scaleX(0.8);}
>>>>>>> 60845a2fc1ad97935f6c1888a4562fc4260fc6b9
...
=======
h1.titulo-principal2{font-family: FjallaOne-Regular;color: #ac805b;font-size: 57px;margin-top: 1em;margin-bottom:1em;}
>>>>>>> 60845a2fc1ad97935f6c1888a4562fc4260fc6b9
...
=======
p.precioproductos2{font-family:Fjalla One; text-align: center;font-size: 1.6em;color: #4A4A4A;width: 300px; font-weight: bold;}
>>>>>>> 60845a2fc1ad97935f6c1888a4562fc4260fc6b9
...
=======
.botoncompra{  -webkit-border-radius: 60;  -moz-border-radius: 60;  border-radius: 60px;  font-family: Arial;  color: #ffffff;  font-size: 20px;  background: #1e3e8c;  padding: 10px 20px 10px 20px;  text-decoration: none;  margin-bottom: 20px;}
.botoncompra:hover{ background: #4673db; text-decoration: none;margin-bottom: 20px;border:none; padding: 12px 22px;}
>>>>>>> 60845a2fc1ad97935f6c1888a4562fc4260fc6b9
...
.precioproductos-m{font-family: FjallaOne-Regular;}
/* ---------------estilos del movil--------------*/
...
=======
.contenedor-creditos {background:rgba(80, 0, 0, 0.53);padding: 40px 0px 40px 0px;font-size: 1.0em;color: white;text-align: center;margin: 7px 0px 0px 0px;}
/* ---------------estilos del movil--------------*/

img-responsive-m {width:100%;display:block;}
.cuerpo-m{background: #8ab0d6;}
.titulo-principal2-m{font-family: FjallaOne-Regular;padding: 1em 1em 0 1.8em; color: white;font-size: 34px;margin-top: 0px;}
.texto-deltitulo2-m{font-family: FjallaOne-Regular;padding: 0 1em 1em 1em;text-align: center;color: #414042;font-size: 1.4em;}
.titulo-principal3-m-2{font-family: FjallaOne-Regular;padding: 1em 1em 0 1.8em; color: white;font-size: 34px;margin-top: 0px;}
div#owl-productodetalle-inicio{background: rgb(136,174,212);
background: -moz-linear-gradient(top, rgb(136,174,212) 0%, rgb(203,235,255) 47%, rgb(203,235,255) 100%);
background: -webkit-linear-gradient(top, rgb(136,174,212) 0%,rgb(203,235,255) 47%,rgb(203,235,255) 100%);
background: linear-gradient(to bottom, rgb(136,174,212) 0%,rgb(203,235,255) 47%,rgb(203,235,255) 100%);
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#88aed4', endColorstr='#cbebff',GradientType=0 );}
...
=======
div#owl-productodetalle-inicio2{background: rgb(241,214,201);
background: -moz-linear-gradient(top, rgb(241,214,201) 0%, rgb(241,214,201) 61%, rgb(253,242,240) 100%);
background: -webkit-linear-gradient(top, rgb(241,214,201) 0%,rgb(241,214,201) 61%,rgb(253,242,240) 100%);
background: linear-gradient(to bottom, rgb(241,214,201) 0%,rgb(241,214,201) 61%,rgb(253,242,240) 100%);
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#f1d6c9', endColorstr='#fdf2f0',GradientType=0 );}
div#owl-productodetalle-inicio3{background: #900;}
.cuerpo2-m{background: #f2d7c8;}
.cuerpo3-m{background: #900;}
.titulo-principal2-m-2{font-family: FjallaOne-Regular;padding: 1em 1em 0 1em; color: #ad815b;font-size: 34px;margin-top: 0.1px;}
.owl-controls{padding-bottom: 2em;}
.contenedor-creditos-m {background:rgba(153, 0, 0, 0.68);;padding: 40px;font-size: 1.0em;color: white;text-align: center;margin:0px;}

@media (max-width: 900px) {{.botoncompra: width: 25%; margin: 0 auto;border-radius: 3.6em;}}
>>>>>>> 60845a2fc1ad97935f6c1888a4562fc4260fc6b9
...
<<<<<<< HEAD
<?php $jabon_exfoliante = Producto::consultarPrecio('63948', $this->objSectorCiudad, 'u')?>
<?php $jabon_forte = Producto::consultarPrecio('63949', $this->objSectorCiudad, 'u')?>
<?php $jabon_soft = Producto::consultarPrecio('65423', $this->objSectorCiudad, 'u')?>
=======
<?php $jabon_exfoliante = Producto::consultarPrecio('63947', $this->objSectorCiudad, 'u')?>
<?php $jabon_forte = Producto::consultarPrecio('63946', $this->objSectorCiudad, 'u')?>
<?php $jabon_soft = Producto::consultarPrecio('63945', $this->objSectorCiudad, 'u')?>
>>>>>>> 60845a2fc1ad97935f6c1888a4562fc4260fc6b9
...
<?php $jabon_maquillajenatural = Producto::consultarPrecio('82323', $this->objSectorCiudad, 'u')?>
<?php $jabon_maquillajebronce = Producto::consultarPrecio('82324', $this->objSectorCiudad, 'u')?>
<?php $jabon_maquillajebeigemate = Producto::consultarPrecio('82325', $this->objSectorCiudad, 'u')?>
<?php $jabon_maquillajeclaromate = Producto::consultarPrecio('83241', $this->objSectorCiudad, 'u')?>
<<<<<<< HEAD
<?php $gel_spot = Producto::consultarPrecio('63950', $this->objSectorCiudad, 'u')?>
<?php $camouflaje = Producto::consultarPrecio('63944', $this->objSectorCiudad, 'u')?>
=======
>>>>>>> 60845a2fc1ad97935f6c1888a4562fc4260fc6b9
...
<!-- <h2 class="texto-deltitulo2-m">ASEPXIA PENETRA PROFUNDAMENTE EN CADA PORO Y AYUDA A ELIMINAR EL EXCESO DE GRASA,GRANITOS O PUNTOS NEGROS.</h2>-->
      ...
      <img class="img-responsive img-producto" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/asepxia/images/platilla-producto.png" alt="Para eliminar las imperfecciones">
        <div class=" textoproductos-m">
            <h4 class="tituloproductos-m">ASEPXIA TOALLITAS DE LIMPIEZA X25 unidades</h4>
             ...
             <p class="precioproductos-m"><?= ($jabon_exfoliante == null) ? "--" : Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], $jabon_exfoliante, Yii::app()->params->formatoMoneda['moneda']) ?></p>
<<<<<<< HEAD
...
=======
             <a data-ajax="false" href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 63947)) ?>"><button class="botoncompra" type="button" name="button">Comprar</button> </a>
        </div>
    </div>
    <div class="item secciondelproducto">
        <img class="img-responsive img-producto" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/asepxia/images/asepxia-jabon-forte.png" alt="Remueve células muertas con efecto astringente.  ">
>>>>>>> 60845a2fc1ad97935f6c1888a4562fc4260fc6b9
        <div class=" textoproductos-m">
            <h4 class="tituloproductos-m">ASEPXIA TOALLITAS DE LIMPIEZA X10 unidades</h4>
             <p class="textoproductos-m">Dile adiós al brillo de tu cara con Toallitas Asepxia.</p>
             <p class="precioproductos-m"><?= ($jabon_forte == null) ? "--" : Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], $jabon_forte, Yii::app()->params->formatoMoneda['moneda']) ?></p>
<<<<<<< HEAD
...
=======
             <a data-ajax="false" href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 63946)) ?>" ><button class="botoncompra" type="button" name="button">Comprar</button> </a>
>>>>>>> 60845a2fc1ad97935f6c1888a4562fc4260fc6b9
        </div>
    </div>
    <div class="item secciondelproducto">
      ...
      <div class="textoproductos-m">
          <h4 class="tituloproductos-m">ASEPXIA GEL EXFOLIANTE PARA PUNTOS NEGROS</h4>
           ...
           <p class="precioproductos-m"><?= ($jabon_soft == null) ? "--" : Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], $jabon_soft, Yii::app()->params->formatoMoneda['moneda']) ?></p>
<<<<<<< HEAD
...
=======
           <a data-ajax="false" href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 63945)) ?>" ><button class="botoncompra" type="button" name="button">Comprar</button> </a>
>>>>>>> 60845a2fc1ad97935f6c1888a4562fc4260fc6b9
    </div>
  </div>
      ...
      <img class="img-responsive img-producto" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/asepxia/images/plantilla-producto-2.png" alt="Para eliminar las imperfecciones">
        <div class=" textoproductos-m">
            <h4 class="tituloproductos-m"> ASEPXIA MAQUILLAJE NATURAL</h4>
             ...
             <p class="precioproductos-m"><?= ($jabon_maquillajenatural == null) ? "--" : Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], $jabon_maquillajenatural, Yii::app()->params->formatoMoneda['moneda']) ?></p>
<<<<<<< HEAD
...
=======
             <a data-ajax="false" href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 82323)) ?>" ><button class="botoncompra" type="button" name="button">Comprar</button> </a>
>>>>>>> 60845a2fc1ad97935f6c1888a4562fc4260fc6b9
        </div>
    </div>
    <div class="item secciondelproducto">
        ...
        <div class=" textoproductos-m">
            <h4 class="tituloproductos-m">ASEPXIA MAQUILLAJE BRONCE</h4>
             ...
             <p class="precioproductos-m"><?= ($jabon_maquillajebronce == null) ? "--" : Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], $jabon_maquillajebronce, Yii::app()->params->formatoMoneda['moneda']) ?></p>
<<<<<<< HEAD
...
=======
             <a data-ajax="false" href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 82324)) ?>" ><button class="botoncompra" type="button" name="button">Comprar</button> </a>
>>>>>>> 60845a2fc1ad97935f6c1888a4562fc4260fc6b9
        </div>
    </div>
    <div class="item secciondelproducto">
      ...
      <div class="textoproductos-m">
          <h4 class="tituloproductos-m"> ASEPXIA MAQUILLAJE <br> BEIGE MATE</h4>
           <p class="textoproductos-m">Cubre y cuida tus imperfecciones con Polvos Asepxia. </p>
           <p class="precioproductos-m"><?= ($jabon_maquillajebeigemate == null) ? "--" : Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], $jabon_maquillajebeigemate, Yii::app()->params->formatoMoneda['moneda']) ?></p>
<<<<<<< HEAD
...
=======
           <a data-ajax="false" href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 83225)) ?>" ><button class="botoncompra" type="button" name="button">Comprar</button> </a>
>>>>>>> 60845a2fc1ad97935f6c1888a4562fc4260fc6b9
    </div>
  </div>
    <div class="item secciondelproducto">
      ...
      <div class=" textoproductos-m">
          <h4 class="tituloproductos-m">  ASEPXIA MAQUILLAJE <br> CLARO MATE</h4>
           ...
           <p class="precioproductos-m"><?= ($jabon_maquillajeclaromate == null) ? "--" : Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], $jabon_maquillajeclaromate, Yii::app()->params->formatoMoneda['moneda']) ?></p>
<<<<<<< HEAD
...
=======
           <a data-ajax="false" href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 82341)) ?>" ><button class="botoncompra" type="button" name="button">Comprar</button> </a>
>>>>>>> 60845a2fc1ad97935f6c1888a4562fc4260fc6b9
    </div>
  </div>
</section>
...
<<<<<<< HEAD
             <p class="precioproductos-m"><?= ($gel_spot == null) ? "--" : Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], $gel_spot, Yii::app()->params->formatoMoneda['moneda']) ?></p>
      ...
      <div class="row textoproductos-m">
          <h4 class="tituloproductos-m">Asepxia Emergencia Color Piel Camouflage</h4>
           <p class="textoproductos-m">Cuando te salen granitos sin avisar, Asepxia Camouflage está de tu lado para combatirlos. </p>
              ...
              <p style="margin: 0px;height:14px;">&nbsp;</p>
<<<<<<< HEAD
             <p class="precioproductos-m"><?= ($camouflaje == null) ? "--" : Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], $camouflaje, Yii::app()->params->formatoMoneda['moneda']) ?></p>
...
<!--VERSIÓN ESCRITORIO-->
<?php else: ?>
<img class="img-responsive" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/asepxia/images/banner-asepxia.png" alt="Para eliminar las imperfecciones">
>>>>>>> 60845a2fc1ad97935f6c1888a4562fc4260fc6b9
<section class="cuerpo">
  ...
  <div>
    <div class="row cuerpotitulo">
      ...
      <!--<h2 class="texto-deltitulo">ASEPXIA PENETRA PROFUNDAMENTE EN CADA PORO Y AYUDA A ELIMINAR EL EXCESO<br> DE GRASA,GRANITOS O PUNTOS NEGROS.</h2>-->
    </div>
    <br>
    <div class="row">
            ...
            <img class="img-responsive img-producto" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/asepxia/images/platilla-producto.png" alt="Para eliminar las imperfecciones">
              <div class="row textoproductos">
                  <h4 class="tituloproductos"> ASEPXIA TOALLITAS DE LIMPIEZA <br> X25 unidades</h4>
                   ...
                   <p class="precioproductos"><?= ($jabon_exfoliante == null) ? "--" : Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], $jabon_exfoliante, Yii::app()->params->formatoMoneda['moneda']) ?></p>
<<<<<<< HEAD
...
=======
                   <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 63947)) ?>" ><button class="botoncompra" type="button" name="button">Comprar</button> </a>
>>>>>>> 60845a2fc1ad97935f6c1888a4562fc4260fc6b9
...
>>>>>>> 60845a2fc1ad97935f6c1888a4562fc4260fc6b9
            <div class="row textoproductos">
                <h4 class="tituloproductos">ASEPXIA TOALLITAS DE LIMPIEZA <br> X10 unidades</h4>
                 <p class="textoproductos">Dile adiós al brillo de tu cara con Toallitas Asepxia. </p>
                 <p class="precioproductos"><?= ($jabon_forte == null) ? "--" : Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], $jabon_forte, Yii::app()->params->formatoMoneda['moneda']) ?></p>
<<<<<<< HEAD
...
=======
                 <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 63946)) ?>" ><button class="botoncompra" type="button" name="button">Comprar</button> </a>
>>>>>>> 60845a2fc1ad97935f6c1888a4562fc4260fc6b9
          ...
          <div class="col-sm-4 col-md-4">
            ...
            <div class="row textoproductosparabajar">
                <h4 class="tituloproductos">ASEPXIA GEL EXFOLIANTE PARA<BR> PUNTOS NEGROS</h4>
                 ...
                 <p class="precioproductos"><?= ($jabon_soft == null) ? "--" : Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], $jabon_soft, Yii::app()->params->formatoMoneda['moneda']) ?></p>
<<<<<<< HEAD
...
=======
                 <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 63945)) ?>" ><button class="botoncompra" type="button" name="button">Comprar</button> </a>
>>>>>>> 60845a2fc1ad97935f6c1888a4562fc4260fc6b9
            ...
            <img class="img-responsive img-producto2" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/asepxia/images/plantilla-producto-2.png" alt="Para eliminar las imperfecciones">
              <div class="row textoproductos2">
                  <h4 class="tituloproductos2">ASEPXIA MAQUILLAJE NATURAL</h4>
                   ...
                   <p class="precioproductos2"><?= ($jabon_maquillajenatural == null) ? "--" : Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], $jabon_maquillajenatural, Yii::app()->params->formatoMoneda['moneda']) ?></p>
<<<<<<< HEAD
...
=======
                   <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 82323)) ?>" ><button class="botoncompra" type="button" name="button">Comprar</button> </a>
>>>>>>> 60845a2fc1ad97935f6c1888a4562fc4260fc6b9
          ...
          <div class="col-sm-4 col-md-4">
            ...
            <div class="row textoproductos2">
                <h4 class="tituloproductos2"> ASEPXIA MAQUILLAJE BRONCE</h4>
                 <p class="textoproductos2">Cubre y cuida tus imperfecciones con Polvos Asepxia. </p>
                 <p style="margin:0px;">&nbsp;</p>
                 <p class="precioproductos2"><?= ($jabon_maquillajebronce == null) ? "--" : Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], $jabon_maquillajebronce, Yii::app()->params->formatoMoneda['moneda']) ?></p>
<<<<<<< HEAD
...
=======
                 <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 82324)) ?>" ><button class="botoncompra" type="button" name="button">Comprar</button> </a>
>>>>>>> 60845a2fc1ad97935f6c1888a4562fc4260fc6b9
          ...
          <div class="col-sm-offset-2 col-md-4">
            ...
            <div class="row textoproductos2">
                <h4 class="tituloproductos2"> ASEPXIA MAQUILLAJE <br> BEIGE MATE</h4>
                 <p class="textoproductos2">Cubre y cuida tus imperfecciones con Polvos Asepxia. </p>
                 <p class="precioproductos2"><?= ($jabon_maquillajebeigemate == null) ? "--" : Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], $jabon_maquillajebeigemate, Yii::app()->params->formatoMoneda['moneda']) ?></p>
<<<<<<< HEAD
...
=======
                 <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 83225)) ?>" ><button class="botoncompra" type="button" name="button">Comprar</button> </a>
>>>>>>> 60845a2fc1ad97935f6c1888a4562fc4260fc6b9
            ...
            <div class="row textoproductos2">
                <h4 class="tituloproductos2"> ASEPXIA MAQUILLAJE <br> CLARO MATE</h4>
                 <p class="textoproductos2">Cubre y cuida tus imperfecciones con Polvos Asepxia. </p>
                 <p class="precioproductos2"><?= ($jabon_maquillajeclaromate == null) ? "--" : Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], $jabon_maquillajeclaromate, Yii::app()->params->formatoMoneda['moneda']) ?></p>
<<<<<<< HEAD
...
=======
                 <a href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 82341)) ?>" ><button class="botoncompra" type="button" name="button">Comprar</button> </a>
>>>>>>> 60845a2fc1ad97935f6c1888a4562fc4260fc6b9
...
<<<<<<< HEAD
              <h4 class="tituloproductos2">ASEPXIA EMERGENCIA SPOT TRANSPARENTE</h4>
               ...
               <p style="margin:0px;">&nbsp;</p>
               <p class="precioproductos2"><?= ($gel_spot == null) ? "--" : Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], $gel_spot, Yii::app()->params->formatoMoneda['moneda']) ?></p>
...
<<<<<<< HEAD
            <h4 class="tituloproductos2">ASEPXIA EMERGENCIA COLOR PIEL CAMOUFLAGE</h4>
             ...
             <p style="margin:0px;">&nbsp;</p>
             <p class="precioproductos2"><?= ($camouflaje == null) ? "--" : Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], $camouflaje, Yii::app()->params->formatoMoneda['moneda']) ?></p>
