...
.contenedor-publicidad {
  height: 800px;
width: 100%;
background-image: url(/lrv/images/contenido/genfar-kids/bruubruu/Fondo-producto.jpg);
...
<?php if ($this->isMobile): ?>
  <a href="<?= Yii::app()->request->baseUrl ?>/catalogo/buscar?busqueda=klim">
    <img class="img-responsive-m" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/genfar-kids/bruubruu/Banner-Bruu-Bruu.jpg" alt="genfar kids">
  </a>
<div>
  <div class="contenedor-publicidadm">
    <div class="contenedor-munecam">
      <h4 style="    font-family: font-family: FrutigerLTStd-Bold; position: absolute;text-align: center;top:11.3%;%;font-size: 11px;right: 15%;color: #155d6f;">Es el síntoma que aparece <strong>cuando se ponen calienticos<br>y sienten mucho frio,</strong>es ese malestar que no los deja jugar.</h4>
      <a href="<?= Yii::app()->request->baseUrl ?>/catalogo/buscar?busqueda=klim">
        <img class="img-responsive" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/genfar-kids/bruubruu/Producto-bruu-bruu.png" alt="genfar kids">
      </a>
    </div>
    <div class="contenedor-videom">
    <img class="img-responsive" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/genfar-kids/bruubruu/Video-bruu-bruu.png" alt="genfar kids">
    </div>

    <img class="img-responsive fondo-publicidadm" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/genfar-kids/bruubruu/Fondo-producto.jpg" alt="genfar kids">
  </div>
...
<?php else: ?>
 ...
 <a data-ajax="false" href="<?php echo CController::createUrl('/contenido/ver', array('tipo' => 'grupo', 'contenido' => 117520)) ?>">
<img class="img-responsive" src="<?= Yii::app()->request->baseUrl ?>/images/contenido/genfar-kids/bruubruu/Banner-Bruu-Bruu.jpg" alt="genfar kids">
</a>
...
<div class="contenedor-publicidad">
  <div class="contenedor-muneca">
    ...
    <div class="titulomuneca">
      <h4 class="tamano-h4">Es el síntoma que aparece <span class="tamano-span">cuando se ponen calienticos<br>y sienten mucho frio, </span>es ese malestar que no los deja jugar.</h4>
    </div>

    <a data-ajax="false" href="<?php echo CController::createUrl('/catalogo/producto', array('producto' => 117520 )) ?>">
    <img class="img-responsive" src="/lrv/images/contenido/genfar-kids/bruubruu/Producto-bruu-bruu.png" alt="genfar kids">
    </a>
    </div>
    <div class="contenedor-video">
    <img class="img-responsive" src="/lrv/images/contenido/genfar-kids/bruubruu/Video-bruu-bruu.png" alt="genfar kids">
    </div>
