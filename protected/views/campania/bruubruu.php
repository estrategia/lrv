...
.contenedor-publicidad {
  height: 800px;
width: 100%;
background-image: url(".Yii::app()->request->baseUrl."/images/contenido/genfar-kids/bruubruu/fondo-producto.jpg);
...
<div>
  <div class="contenedor-publicidadm">
    ...
    <div class="contenedor-videom">
      <a href="#" class="bmd-modalButton" data-toggle="modal" data-bmdsrc="https://www.youtube.com/embed/z1M3iQNFysc?rel=0&amp;controls=0&amp;showinfo=0" data-bmdwidth="800" data-bmdheight="400" data-target="#myModal" data-bmdvideofullscreen="true">
