    ...
    <div id="pagewrap">
        ...
        <div style="background: #fff; margin: 30px auto; padding: 20px 35px; width: 600px; -webkit-border-radius: 8px; -moz-border-radius: 8px; border-radius: 8px; -webkit-box-shadow: 0 1px 3px rgba(0,0,0,.4); -moz-box-shadow: 0 1px 3px rgba(0,0,0,.4); box-shadow: 0 1px 3px rgba(0,0,0,.4);">
            <article style="display: inline-block;">
                <h2 style="background: #FB1818; border-radius: 5px; padding: 5px 5px; border-top: 1px solid #B10F0F; border-bottom: 1px solid #B10F0F; text-align: center; color: #FFFFFF; margin-bottom: 20px;">Desbloqueo de cuenta</h2>	
                <figure style="float: left; margin: 5px; max-width: 260px;"> 
                    <img src="http://localhost/lrv/images/bloqueo/cuenta_desbloqueada.png" width="200" height="186"> 
                </figure>
                <p style="margin: 0 0 1.2em; padding: 0; text-align: justify;">Tu cuenta de usuario <strong><?=$identificacionUsuario?></strong> ha sido desbloqueada. Fue bloqueada anteriormente por el motivo de exceder los limites de compra permitidos.</p>
