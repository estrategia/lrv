<div class="ui-content c_cont_detail_prod inComboDesciption">
 ...
 <div class="cdiv_prod_desc">
    ...
    <?php echo CHtml::link('Guardar en la lista personal', '#', array('data-role' => 'lstpersonalguardar', 'data-tipo' => 2, 'data-codigo' => $objCombo->idCombo, 'class' => 'ui-btn ui-corner-all ui-shadow ui-btn-n btn_add_lst_pr')); ?>
</div>
