        ...
        <div class="container">
            <div class="col-md-12">
                <div class="col-md-6">
                    ...
                    <div id="owl-productodetalle-<?php echo $objProducto->codigoProducto ?>" class="">
                       ...
                       <!--     <div id="raty-lectura-producto-<?php echo $objProducto->codigoProducto ?>" data-role="raty" data-readonly="true" data-score="<?php echo $objProducto->getCalificacion() ?>" class=""></div> -->
                           ...
                           <?php endif; ?>
                            ...
                            <div class="col-md-12 line-bottom">
                                        <button class="col-md-2 min" style="border:1px solid;" id="disminuir_cantidad_ubicacion_<?php echo $objProducto->codigoProducto ?>" onclick="cambioUnidadesUbicacion('<?php echo $objProducto->codigoProducto ?>',<?= $objPrecio->getPrecio(Precio::PRECIO_UNIDAD)?>,0)" type="button"><span style="color:white" class="glyphicon glyphicon-minus"></span></button>
                                        ...
                                        <button class="col-md-2 min" style="border:1px solid;" id="aumentar_cantidad_ubicacion_<?php echo $objProducto->codigoProducto ?>" onclick="cambioUnidadesUbicacion('<?php echo $objProducto->codigoProducto ?>',<?= $objPrecio->getPrecio(Precio::PRECIO_UNIDAD)?>,1)" type="button"><span style="color:white" class="glyphicon glyphicon-plus"></span></button>
                            </div>
                            <div class="">
                            ...
                            <div class="col-md-12 line-bottom">
                                        ...
                                        <button class="col-md-2 min" style="border:1px solid;" id="aumentar_cantidad_bodega_<?php echo $objProducto->codigoProducto ?>" onclick="cambioUnidadesBodega('<?php echo $objProducto->codigoProducto ?>',<?= $objPrecio->getPrecio(Precio::PRECIO_UNIDAD)?>,1)" type="button"><span style="color:white" class="glyphicon glyphicon-plus"></span></button>
                            </div>
                            <div class="">
