<?php if ($tipoBusqueda == Yii::app()->params->busqueda['tipo']['categoria']): ?>
    ...
    <div class="">
        ...
        <div id="collapseFour-" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingFour">
            <div class="panel-body">
                <div class="center">
                  <h4 class="panel-title">Calificación</h4>
    ...
    <div class="text-center">
        <a href="#" data-role="filtro-listaproductos-reset" data-tipo="1" ><div class="btn btn-primary btn-block">Limpiar filtros</div></a>
    </div>
    <?php $this->endWidget(); ?>
<?php endif; ?>
