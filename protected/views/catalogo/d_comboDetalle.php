                ...
                <div class="descripciones">
                    <div class="col-md-12" style="color:#A3A3A3;font-size: 16px;">
                        ...
                        <div class="col-md-12 line-bottom" style="margin-top: 15px;">
                            <button class="col-md-3 min" style="border:1px solid;" id="btn-disminuir-combo-<?php $objCombo->idCombo ?>" onclick="disminuirCantidadCombo('<?php echo $objCombo->idCombo ?>',<?php echo $objPrecio->getPrecio() ?>)" type="button"><span class="glyphicon glyphicon-minus"></span></button>
                            ...
                            <button class="col-md-3 min" style="border:1px solid;" id="btn-aumentar-combo-<?php echo $objCombo->idCombo ?>"  onclick="aumentarCantidadCombo('<?php echo $objCombo->idCombo ?>',<?php echo $objPrecio->getPrecio() ?>)" type="button"><span class="glyphicon glyphicon-plus"></span></button>
                        </div>
