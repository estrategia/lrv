                                          ...
                                          <div class="ad-thumbs">
                                            ...
                                            <?php foreach ($objCombo->listProductos as $objProducto): ?>
                                                 ...
                                                 <?php $imagen = $objProducto->objImagen(YII::app()->params->producto['tipoImagen']['mini']); ?>
                                                        ...
                                                        <?php if ($imagen == null): ?>
                                                            <?php $rutaImagenMini = Yii::app()->request->baseUrl . Yii::app()->params->producto['noImagen']['mini']; ?>
                                                            <?php $rutaImagenGrande = Yii::app()->request->baseUrl . Yii::app()->params->producto['noImagen']['grande']; ?>
                                                        <?php else: ?>
                                                            <?php $rutaImagenMini = Yii::app()->request->baseUrl . Yii::app()->params->carpetaImagen['productos'][YII::app()->params->producto['tipoImagen']['mini']] . $imagen->rutaImagen; ?>
                                                            <?php $rutaImagenGrande = Yii::app()->request->baseUrl . Yii::app()->params->carpetaImagen['productos'][YII::app()->params->producto['tipoImagen']['grande']] . $imagen->rutaImagen; ?>
                                                        <?php endif; ?>
                                                
                                                        <li>
                                                            <a style="width:60%" href="<?php echo $rutaImagenGrande ?>">
                                                                <img class="img-responsive" src="<?php echo $rutaImagenMini ?>" >
