<?php foreach ($listCiudadesSubsectores as $ciudad): ?>
    <?php foreach ($ciudad->listSubSectores as $subSector): ?>
        <div data-role="panel" data-position-fixed="true" id="subsector-panel-<?php echo $subSector->codigoSubSector ?>" class="c_ubi_pop" data-position="right" data-display="overlay">
                    ...
                    <div data-role="collapsible" data-iconpos="right" data-collapsed-icon="carat-d" data-expanded-icon="carat-u">
                        ...
                        <ul data-role="listview" data-inset="false" data-icon="false">
                            <?php foreach ($referencia->listSectores as $sector): ?>
                                <li class="c_lnk_sel">
                                    <a href="<?php echo CController::createUrl('/sitio/ubicacionSeleccion', array('ciudad' => $ciudad->codigoCiudad, 'sector' => $sector->codigoSector, 'subsector' => $subSector->codigoSubSector)) ?>" data-ajax="false" class="" ><?php echo $sector->nombreSector ?></a>
                                </li>
                            <?php endforeach; ?>
                        </ul>
                    </div>
