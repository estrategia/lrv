<div id='seleccion-ciudad' data-role="page">
    <div data-role='main' class='ui-content'>
        ...
        <div class="page-footer center">
            ...
            <a id="confirma-ubicacion" style="width: 35%;" href="#" class='ui-btn ui-btn-n ui-corner-all ui-shadow ui-mini float-right' data-role="confirmar-seleccion-ciudad">Confirmar</a>
        </div>
    </div>
</div>
