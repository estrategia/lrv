...
<div class="ui-content">
    ...
    <?php echo CHtml::htmlButton('Aceptar', array('class' => 'ui-btn ui-btn-a ui-corner-all ui-alt-icon', 'data-role' => 'ubicacion-mapa')); ?>
    <form id="form-ubicacion"  method="post" action="<?php echo $this->createUrl("/sitio/ubicacionSeleccion") ?>">
        ...
        <?php echo CHtml::htmlButton('Aceptar', array('class' => 'ui-btn ui-btn-a ui-corner-all ui-alt-icon', 'data-role' => 'ubicacion-seleccion')); ?>
    </form>
</div>
