<?php if (Yii::app()->session[Yii::app()->params->sesion['tipoEntrega']] == Yii::app()->params->entrega['tipo']['domicilio']): ?>
    <?php if ($modelPago->pagoInvitado): ?>
        ...
        <div class="form-group">
            <?php echo $form->labelEx($modelPago, 'descripcion', array('class' => 'control-label')); ?>
        ...
        <div class="form-group">
            <?php echo $form->labelEx($modelPago, 'nombre', array('class' => 'control-label')); ?>
        ...
        <div class="form-group">
            <?php echo $form->labelEx($modelPago, 'direccion', array('class' => 'control-label')); ?>
        ...
        <div class="form-group">
            <?php echo $form->labelEx($modelPago, 'barrio', array('class' => 'control-label')); ?>
        ...
        <div class="form-group">
            <?php echo $form->labelEx($modelPago, 'telefono', array('class' => 'control-label')); ?>
        ...
        <div class="form-group">
            <?php echo $form->labelEx($modelPago, 'extension', array('class' => 'control-label')); ?>
        ...
        <div class="form-group">
            <?php echo $form->labelEx($modelPago, 'celular', array('class' => 'control-label')); ?>
