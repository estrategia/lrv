...
<?php else: ?>
    <tr>
        <td>
            <img src="<?php echo Yii::app()->request->baseUrl . $objProducto->rutaImagen() ?>" title="<?php echo $objProducto->descripcionProducto ?>"> 
            <div><?php echo $objProducto->descripcionProducto ?></div>
            <div><?php echo $objProducto->presentacionProducto ?></div>
            <div>Código: <?php echo $objProducto->codigoProducto ?></div>
        </td>
        <td><input type="text" class="inputmini" value="<?php echo $position->getQuantityUnit() ?>" id="cantidad-producto-unidad-<?php echo $objProducto->codigoProducto ?>"></td>
        <td>
        ...
        <td><?php echo Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], $position->getDiscountPrice(), Yii::app()->params->formatoMoneda['moneda']); ?></td>
        ...
        <td><?php echo Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], $position->getSumPriceUnit(false, true), Yii::app()->params->formatoMoneda['moneda']); ?></td>
    </tr>
<?php endif; ?>