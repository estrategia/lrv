<div class="clst_cont_top">
    ...
    <div class="clst_cont_pr_prod">
        ...
        <?php endif; ?>
        <div class="clst_pre_act"><span>[Flete <?php echo Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], Yii::app()->shoppingCart->getShippingStored(), Yii::app()->params->formatoMoneda['moneda']); ?>]</span></div>
