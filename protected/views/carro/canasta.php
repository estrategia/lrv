    ...
    <?php if (!Yii::app()->shoppingCart->isEmpty()): ?>
        <?php if (Yii::app()->shoppingCart->getCount() > 1): ?>
            ...
            <div class="subtotalCanasta">
                ...
                <?php echo CHtml::link('Pagar', CController::createUrl('/carro'), array('data-ajax' => 'false', 'class' => 'ui-btn ui-corner-all ui-shadow ui-btn-r')); ?>

                <?php if (Yii::app()->shoppingCart->getObjExpress() != null): ?>
                    <?php echo CHtml::link('Pago Express', "#", array('data-role' =>'popup-pagoexpress', 'data-ajax' => 'false', 'class' => 'ui-btn ui-corner-all ui-shadow ui-btn-r')); ?>
                <?php endif; ?>
