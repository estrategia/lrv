<fieldset>
    <div data-role="collapsibleset">
        ...
        <div data-role="collapsible">
            <h3>Adjuntar Información del Médico</h3>
            <div class="ui-field-container">
            ...
            <div class="ui-field-container">
                ...
                <?php echo $form->textField($model, 'registroMedico', array('maxlength' => 10, 'placeholder' => $model->getAttributeLabel('registroMedico'))); ?>
                <?php echo $form->error($model, 'registroMedico'); ?>
            </div>
            <div class="ui-field-container">
                <?php echo $form->labelEx($model, 'telefono', array('class' => '')); ?>
                <?php echo $form->numberField($model, 'telefono', array('maxlength' => 20, 'placeholder' => $model->getAttributeLabel('telefono'))); ?>
                <?php echo $form->error($model, 'telefono'); ?>
            </div>
            <div class="ui-field-container">
                <?php echo $form->labelEx($model, 'correoElectronico', array('class' => '')); ?>
                <?php echo $form->textField($model, 'correoElectronico', array('maxlength' => 50, 'placeholder' => $model->getAttributeLabel('correoElectronico'))); ?>
