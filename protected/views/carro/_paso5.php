<?php if ($modelPago->pagoExpress): ?>
    ...
    <div class="contentConfirmacion">
        ...
        <div class="btnPagarConfirmacion ui-field-container ui-bar ui-bar-a ui-corner-all">
            <div>Total a pagar <?php echo Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], Yii::app()->shoppingCart->getTotalCostClient(), Yii::app()->params->formatoMoneda['moneda']) ?></div>
