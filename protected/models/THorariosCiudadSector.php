 ...
 */
class THorariosCiudadSector extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('codigoCiudad, codigoSector, horaInicioLunesASabado, horaFinLunesASabado, horaInicioDomingoFestivo, horaFinDomingoFestivo', 'required'),
    ...
    public function attributeLabels() {
        return array(
            ...
            'horaInicioLunesASabado' => 'Hora Inicio Lunes Asabado',
            'horaFinLunesASabado' => 'Hora Fin Lunes Asabado',
     ...
     * @return THorariosCiudadSector the static model class
     */
