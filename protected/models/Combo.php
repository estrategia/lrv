...
class Combo extends CActiveRecord {
    ...
    public function relations() {
        ...
        return array(
            ...
            'listImagenesComboGrande' => array(self::HAS_MANY, 'ImagenCombo', 'idCombo', 'condition'=>'listImagenesComboGrande.estadoImagen=1 AND listImagenesComboGrande.tipoImagen='. YII::app()->params->producto['tipoImagen']['grande']),
        );
    }
