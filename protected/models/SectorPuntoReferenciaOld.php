 ...
 */
class SectorPuntoReferenciaOld extends CActiveRecord {

    /**
     * @return string the associated database table name
     */
    public function tableName() {
        return 'm_SectorPuntoReferenciaOld';
    }
    ...
    public function rules() {
        ...
        return array(
            array('idPuntoReferencia, codigoSector', 'required'),
            array('idPuntoReferencia', 'numerical', 'integerOnly' => true),
            array('codigoSector', 'length', 'max' => 10),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('idPuntoReferencia, codigoSector', 'safe', 'on' => 'search'),
        );
    }
