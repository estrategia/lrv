...
class BeneficiosComprasItems extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('idCompraItem, tipo, fechaIni, fechaFin, fechaCreacionBeneficio', 'required'),
			array('idCompraItem, tipo, dsctoUnid, dsctoFrac, vtaUnid, vtaFrac, pagoUnid, pagoFrac, cuentaCop, nitCop, porcCop, cuentaProv, porcProv, promoFiel, swobligaCli', 'numerical', 'integerOnly'=>true),
			array('nitProv', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('idBeneficio, idCompraItem, tipo, fechaIni, fechaFin, dsctoUnid, dsctoFrac, vtaUnid, vtaFrac, pagoUnid, pagoFrac, cuentaCop, nitCop, porcCop, cuentaProv, nitProv, porcProv, promoFiel, swobligaCli, fechaCreacionBeneficio', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'idCompraItem0' => array(self::BELONGS_TO, 'TComprasitems', 'idCompraItem'),
		);
	}
