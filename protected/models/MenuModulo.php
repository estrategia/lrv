...
/**
 * This is the model class for table "m_MenuModulo".
 *
 * The followings are the available columns in table 'm_MenuModulo':
 ...
 */
class MenuModulo extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('idModulo, rutaImagen, contenido, color', 'required'),
            ...
            array('idModulo, rutaImagen, contenido, color', 'safe', 'on' => 'search'),
        );
    }
     ...
     * @return MenuModulo the static model class
     */
