...
class DireccionesDespacho extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('identificacionUsuario, direccion', 'length', 'min' => 5, 'max' => 100, 'on' => 'insert, update'),
            array('descripcion', 'length', 'min' => 3, 'max' => 50, 'on' => 'insert, update'),
            array('nombre, barrio', 'length', 'min' => 5, 'max' => 50, 'on' => 'insert, update'),
            array('celular', 'length', 'min' => 5, 'max' => 20, 'on' => 'insert, update'),
            array('telefono', 'length', 'min' => 5, 'max' => 11, 'on' => 'insert, update'),
            array('extension', 'length', 'max' => 5, 'on' => 'insert, update'),
            array('codigoCiudad, codigoSector', 'length', 'max' => 10, 'on' => 'insert, update'),
            array('pdvAsignado', 'length', 'max' => 3, 'on' => 'insert, update'),
            array('celular, extension, pdvAsignado', 'default', 'value' => null),
            array('codigoCiudad', 'validarCiudadSector', 'on' => 'insert, update'),
