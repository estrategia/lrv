...
class ComprasItems extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('idCompra, precioBaseUnidad, precioBaseFraccion, descuentoUnidad, descuentoFraccion, precioTotalUnidad, precioTotalFraccion, codigoDescuento, codigoOperador, terceros, unidades, fracciones, unidadesCedi, impuesto, idEstadoItemTercero, idEstadoItem, flete, disponible, tiempoDespachoHoras, idPromocion', 'numerical', 'integerOnly'=>true),
			array('codigoProducto', 'length', 'max'=>10),
			array('descripcion, presentacion', 'length', 'max'=>100),
			array('tiempoEntrega', 'length', 'max'=>20),
			array('recambio', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('idCompraItem, idCompra, codigoProducto, descripcion, presentacion, precioBaseUnidad, precioBaseFraccion, descuentoUnidad, descuentoFraccion, precioTotalUnidad, precioTotalFraccion, codigoDescuento, codigoOperador, terceros, unidades, fracciones, unidadesCedi, impuesto, idEstadoItemTercero, idEstadoItem, flete, tiempoEntrega, disponible, tiempoDespachoHoras, recambio, idPromocion', 'safe', 'on'=>'search'),
		);
	}
