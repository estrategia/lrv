...
/**
 * This is the model class for table "t_ProductosDescuentosPerfiles".
 *
 * The followings are the available columns in table 't_ProductosDescuentosPerfiles':
 * @property string $codigoProducto
 * @property integer $codigoPerfil
 * @property integer $descuentoPerfil
 */
class ProductosDescuentosPerfiles extends CActiveRecord {

    /**
     * @return string the associated database table name
     */
    public function tableName() {
        return 't_ProductosDescuentosPerfiles';
    }
     ...
     * @return ProductosDescuentosPerfiles the static model class
     */
