...
class UsuarioController extends Controller {
    ...
    public function filters() {
        return array(
            array('application.filters.SessionControlFilter + index, autenticar, infoPersonal, contrasena, pagoexpress, listapedidos, pedido, listacotizaciones, cotizacion, listapersonal, listadetalle, direcciones','isMobile' => $this->isMobile),
