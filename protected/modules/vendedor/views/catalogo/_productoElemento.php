...
<div class="clst_cont_top <?php echo ($objProducto->fraccionado == 1 ? ' top_frc' : '') ?> ">
    ...
    <!-- producto agregado -->
    <a href="" class="clst_slct_prod<?php echo (Yii::app()->getModule('vendedor')->shoppingCartSalesman->contains($objProducto->codigoProducto) ? " active" : "") ?>" id="icono-producto-agregado-<?php echo $objProducto->codigoProducto ?>">
