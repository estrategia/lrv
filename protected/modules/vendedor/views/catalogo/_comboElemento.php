...
<div class="clst_cont_top">
    ...
    <!-- combo agregado -->
    <a href="" class="clst_slct_prod<?php echo (Yii::app()->getModule('vendedor')->shoppingCartSalesman->contains($objCombo->getCodigo()) ? " active" : "") ?> incombo" id="icono-combo-agregado-<?php echo $objCombo->idCombo ?>">
