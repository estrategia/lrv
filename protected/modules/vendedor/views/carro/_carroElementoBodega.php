<div class="clst_cont_top">
    ...
    <div class="clst_cont_pr_prod">
        ...
        <?php if (Yii::app()->getModule('vendedor')->shoppingCartSalesman->getObjCiudad()->excentoImpuestos == 0 && $position->getTax() > 0): ?>
        ...
        <?php endif; ?>
        <div class="clst_pre_act"><span>Tiempo de entrega: <?php echo Yii::app()->getModule('vendedor')->shoppingCartSalesman->getDeliveryStored() ?> hora(s)</span></div>
    </div>
    <div class="clear"></div>
</div>
