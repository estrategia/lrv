<div class="ui-panel-inner">
    <h2>Hay <?php echo Yii::app()->shoppingCartSalesman->getCount(); ?> producto(s) en el carro</h2>
    <?php if (!Yii::app()->shoppingCartSalesman->isEmpty()): ?>
        <?php if (Yii::app()->shoppingCartSalesman->getCount() > 1): ?>
        ...
        <ul data-role="listview" data-inset="true" data-icon="false" class="c_list_prod_cont canastaList">
            <?php foreach (Yii::app()->shoppingCartSalesman->getPositions() as $position): ?>
        ...
        <div class="subtotalCanasta">
            ...
            <?php if (Yii::app()->session[Yii::app()->params->sesion['tipoEntrega']] == Yii::app()->params->entrega['tipo']['domicilio'] && Yii::app()->shoppingCartSalesman->getObjExpress() != null): ?>
