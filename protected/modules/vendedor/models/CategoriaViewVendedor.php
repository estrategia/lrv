...
class CategoriaViewVendedor {
        ...
        foreach ($categorias as $indice => $categoria) {
            ...
            if (empty($categoriaItems)) {
                if ($nivel == 1) {
                    ...
                    echo "<a class='ui-collapsible-inset ui-corner-all ui-btn ui-btn-icon-right ui-btn-inherit ui-icon-carat-r align-left $clase c_btn_catg $claseCategoria' href='" . Yii::app()->createUrl('/vendedor/catalogo/categoria', array('categoria' => $categoria->idCategoriaTienda)) . "' data-ajax='false'>";
                    ...
                    echo "<a class='ui-collapsible-inset ui-corner-all ui-collapsible-themed-content ui-collapsible-collapsed ui-btn ui-btn-icon-right ui-icon-carat-r align-left c_btn_catg_02 $claseCategoria' href='" . Yii::app()->createUrl('/vendedor/catalogo/categoria', array('categoria' => $categoria->idCategoriaTienda)) . "' data-ajax='false'>$categoria->nombreCategoriaTienda</a>";
                }
            } else {
    ...
    private static function generarSubMenuItem(&$categorias, $nivel) {
        ...
        foreach ($categorias as $categoria) {
            echo "<li><a href='" . Yii::app()->createUrl('/vendedor/catalogo/categoria', array('categoria' => $categoria->idCategoriaTienda)) . "' data-ajax='false'>$categoria->nombreCategoriaTienda</a></li>";
        }
        echo "</ul>";
    }
}
