            ...
            <div class="navbar-inner">
                ...
                <div class="btn-group pull-right">
                    ...
                    <ul class="dropdown-menu">
                        <li><?php echo CHtml::link('Cambiar clave', $this->createUrl('/entreganacional/usuario/clave')) ?></li>
                        <li><?php echo CHtml::link('Salir', $this->createUrl('/entreganacional/usuario/salir')) ?></li>
                    </ul>
                ...
                <div class="sidebar-nav">
                    <div class="nav-canvas">
                        ...
                        <ul class="nav nav-pills nav-stacked main-menu">
                            ...
                            <li class="">
                                <a href="<?php echo $this->createUrl('/entreganacional') ?>" class="ajax-link"><i class="glyphicon glyphicon-home"></i><span> Panel de control</span></a>
                            </li>
                            <li class="">
                                <a href="<?php echo $this->createUrl('/entreganacional/pedido/index') ?>" class="ajax-link"><i class="glyphicon glyphicon-shopping-cart"></i><span> Crear pedido</span></a>
                            </li>
                            <li class="">
                                <a href="<?php echo $this->createUrl('/entreganacional/admin/pedidos') ?>" class="ajax-link" target="_blank"><i class="glyphicon glyphicon-list-alt"></i><span> Mis pedidos</span></a>
                            </li>
