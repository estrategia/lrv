...
<section>
    <div class="row">
        ...
        <div class="col-md-3 detalles">
            ...
            <?php if (Yii::app()->getModule('puntoventa')->shoppingCartNationalSale->getObjCiudadDestino()->excentoImpuestos == 0 && Yii::app()->getModule('puntoventa')->shoppingCartNationalSale->getTaxPrice() > 0 && $lectura): ?>
			...
			<?php if (!$lectura) : ?>
                <div class="center">
                    <div class="space-1"></div>
                    <?php echo CHtml::link('Comprar', $this->createUrl('/puntoventa/venta/ventaasistida/carro/pagar'), array('class' => 'btn btn-primary', 'role' => "button")); ?>
                </div>
            <?php endif; ?>
        </div>
    </div>
