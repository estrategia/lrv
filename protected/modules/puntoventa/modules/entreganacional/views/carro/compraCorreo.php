    ...
    <table style="width:100%;border-radius:4px 4px 4px 4px;margin-bottom:20px;border-spacing:0;font-size:14px;border:1px #dddddd solid;color:#666666">
        <tbody>
         <!--   <tr>
            ...
            <?php foreach (Yii::app()->shoppingCartNationalSale->getPositions() as $indice => $position): ?>
                ...
                <tr>
                    ...
                    <td width="250" valign="top">
                        <div>
                            <table cellpadding="7" border="0" style="border-left:1px solid #cccccc;border-right:1px solid #cccccc;border-top:1px solid #cccccc;color:#666666;margin-top:20px;width:100%">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:center">
                                            <b><?php echo Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], Yii::app()->shoppingCartNationalSale->getCost(), Yii::app()->params->formatoMoneda['moneda']); ?></b>
                                        </td>
                                    </tr>
                                ...
                                <?php if (Yii::app()->shoppingCartNationalSale->getExtraShipping() > 0): ?>
                                    <tr>
                                        ...
                                        <td><?php echo Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], Yii::app()->shoppingCartNationalSale->getExtraShipping(), Yii::app()->params->formatoMoneda['moneda']); ?></td>
                                    </tr>
                                <?php endif; ?>
                                <?php if (Yii::app()->shoppingCartNationalSale->getBono() > 0): ?>
                                    <tr>
                                        <td>Bono</td>
                                        <td><?php echo Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], Yii::app()->shoppingCartNationalSale->getBono(), Yii::app()->params->formatoMoneda['moneda']); ?></td>
                                    </tr>
                                <?php endif; ?>
                                <?php if (Yii::app()->shoppingCartNationalSale->getObjCiudadOrigen()->excentoImpuestos == 0 && Yii::app()->shoppingCartNationalSale->getTaxPrice() > 0): ?>
                                    <tr>
                                        ...
                                        <td><?php echo Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], Yii::app()->shoppingCartNationalSale->getTaxPrice(), Yii::app()->params->formatoMoneda['moneda']) ?></td>
                                    </tr>
                                <?php endif; ?>
                                <?php if (Yii::app()->shoppingCartNationalSale->getDiscountPrice(true) > 0): ?>
                                    <tr class="rowRed">
                                        <td>Su Ahorro</td>
                                        <td><?php echo Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], Yii::app()->shoppingCartNationalSale->getDiscountPrice(true), Yii::app()->params->formatoMoneda['moneda']) ?></td>
                                    </tr>
                               <?php endif; ?>     
                                </tbody>
                            </table>
                            ...
                            <p style="color:#666666;padding:5px 0;text-align:center;margin:0">- Impuestos incluídos: <?php echo Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], Yii::app()->shoppingCartNationalSale->getTaxPrice(), Yii::app()->params->formatoMoneda['moneda']) ?> -</p>
                            <p style="color:#ff0000;font-size:18px;text-align:center">Su ahorro: <?php echo Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], Yii::app()->shoppingCartNationalSale->getDiscountPrice(true), Yii::app()->params->formatoMoneda['moneda']) ?></p>
                        </div>
                    </td>
                </tr>
            </tbody>
