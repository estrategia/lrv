    ...
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="col-md-12" style="margin-top:20px;">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <?php endif; ?>
                                 <?php if (Yii::app()->shoppingCartNationalSale->getObjCiudadOrigen()->excentoImpuestos == 0 && Yii::app()->shoppingCartNationalSale->getTaxPrice() > 0): ?>
                                <p><?php echo Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], Yii::app()->shoppingCartNationalSale->getTaxPrice(), Yii::app()->params->formatoMoneda['moneda']) ?></p>
                            <?php endif; ?>
                            <?php if (Yii::app()->shoppingCartNationalSale->getDiscountPrice(true) > 0): ?>
                                <p class="rojo"><?php echo Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], Yii::app()->shoppingCartNationalSale->getDiscountPrice(true), Yii::app()->params->formatoMoneda['moneda']) ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
            ...
            $form = $this->beginWidget('CActiveForm', array(
                ...
                'action' => Yii::app()->createUrl('/puntoventa/entreganacional/carro/pagar', array('paso' => $modelPago->getScenario(), 'post' => 'true')),
                'htmlOptions' => array(
                    'class' => "",
            ...
            <div style="margin-top:40px;">
                <div class="row" style="background-color:#fff;">
                    <div class="col-sm-6 col-md-offset-3">
                        <p class="text-center" style="margin-top:20px;color:#A4A4A4;font-size:20px;">TOTAL A PAGAR: <?php echo Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], Yii::app()->shoppingCartNationalSale->getTotalCost(), Yii::app()->params->formatoMoneda['moneda']) ?></p>
                    </div>
                    <div class="col-sm-6 col-md-offset-3">
