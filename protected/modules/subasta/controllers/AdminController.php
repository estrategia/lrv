...
class AdminController extends ControllerOperator {
    ...
    protected function gridDetallePedido($data, $row) {
        ...
        $result = "<a class='btn btn-success  btn-xs' href='" . $this->createUrl('/subasta/admin/detallepedido', $params) . "' target='_blank'><i
    ...
    public function actionCompletitudPdv() {
        if (isset($_POST['compra'])) {
            ...
            try {
                ...
                $this->renderPartial('_modalTotalidadPedido', array(
