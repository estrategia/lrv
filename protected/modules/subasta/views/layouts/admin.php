            ...
            <div class="navbar-inner">
                ...
                <div class="btn-group pull-right">
                    ...
                    <ul class="dropdown-menu">
                        <li><?php echo CHtml::link('Cambiar clave', $this->createUrl('/subasta/usuario/clave')) ?></li>
                        <li><?php echo CHtml::link('Salir', $this->createUrl('/subasta/usuario/salir')) ?></li>
                    </ul>
                ...
                <div class="sidebar-nav">
                    <div class="nav-canvas">
                        ...
                        <ul class="nav nav-pills nav-stacked main-menu">
                            ...
                            <li class="">
                                <a href="<?php echo $this->createUrl('/subasta') ?>" class="ajax-link"><i class="glyphicon glyphicon-home"></i><span> Panel de control</span></a>
                            </li>
                            <li class="">
                                <a href="<?php echo $this->createUrl('/subasta/admin/pedidos') ?>" class="ajax-link" target="_blank"><i class="glyphicon glyphicon-list-alt"></i><span> Pedidos</span></a>
                            </li>
