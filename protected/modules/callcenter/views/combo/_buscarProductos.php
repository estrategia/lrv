<div class="modal fade" id="modal-productos-busqueda-combo" tabindex="-1" role="dialog" aria-labelledby="modal-productos-busqueda-label">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($listProductos as $objProducto): ?>
                            <tr>
                                ...
                                <td> <input id='precio_<?php echo $objProducto->codigoProducto?>' class="form-control" value='' placeholder="Ingrese el precio"/></td>
                                <td>
                                    <?php 
                                        $texto = 'Agregar';
                                        $habilitado = false;
                                    ...
                                    ?>
                                    <?php echo CHtml::link($texto, '#', array('data-producto' => $objProducto->codigoProducto, 'data-role' => "agregar-producto-combo", 'data-combo' => $idCombo, 'class' => 'btn btn-primary', 'disabled' => $habilitado)); ?>
                                </td>
