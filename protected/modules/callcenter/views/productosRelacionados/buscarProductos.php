                        ...
                        <?php foreach ($listProductos as $objProducto): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    ?>
                                    <?php echo CHtml::link($texto, '#', array('data-relacionado' => $objProducto->codigoProducto, 'data-role' => "agregar-producto-relacionado", 'data-producto' => $codigoProducto, 'class' => 'btn btn-primary', 'disabled' => $habilitado)); ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
