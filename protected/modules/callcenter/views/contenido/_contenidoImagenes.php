...
<div class="form-group">
    ...
    <?php echo $form->dropDownList($modelImagen, 'tipoContenido', Yii::app()->params->callcenter['modulosConfigurados']['tiposContenidos'], array('prompt' => 'Seleccione...', 'class' => 'tipoContenido form-control', 'data-role' => 'validar-contenido'));
    ?>
...
<div class='form-group'>   
    <?php echo $form->labelEx($modelImagen, 'rutaImagenMovil', array()); ?>
    <?php echo CHtml::activeFileField($modelImagen, 'rutaImagenMovil', array('value' => $modelImagen->rutaImagen)); ?>
    <?php echo $form->error($modelImagen, 'rutaImagenMovil', array()); ?>
</div>
