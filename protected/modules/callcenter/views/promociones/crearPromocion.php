    ...
    <div class="box-inner">
        ...
        <div class="col-lg-12 col-md-12">
			...
			<div class="form-group"> <!-- calendario -->
                ...
                <?php echo $form->textField($model, 'nombre', array('class' => 'nombre form-control',)); ?>
                <?php echo $form->error($model, 'nombre'); ?>
            </div>
            <div class="form-group"> <!-- calendario -->
                <?php echo $form->labelEx($model, 'url'); ?>
                <?php echo $form->textField($model, 'url', array('class' => 'nombre form-control',)); ?>
           ...
           <div class='form-group'>   
			    <?php echo $form->labelEx($model, 'rutaImagen', array()); ?>
			    <?php echo CHtml::activeFileField($model, 'rutaImagen', array('value' => $model->rutaImagen)); ?>
			    <?php echo $form->error($model, 'rutaImagen', array()); ?>
		   </div>
