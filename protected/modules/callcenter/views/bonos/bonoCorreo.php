...
<div>   
    ...
    Hemos emitido un bono para tí por <?php echo Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], $objBono->valor, Yii::app()->params->formatoMoneda['moneda']) ?> por concepto de
    ...
    <div style="height: 20px;"></div>
    Válido entre el <?php echo Date("d", strtotime($objBono->vigenciaInicio))?> de <?php echo Yii::app()->params->meses[Date("n", strtotime($objBono->vigenciaInicio))]?> del <?php echo Date("Y", strtotime($objBono->vigenciaInicio))?> 
