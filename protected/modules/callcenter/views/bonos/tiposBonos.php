...
<?php if (in_array(Yii::app()->controller->module->user->profile, array(2, 3))): ?>
    <div class="well" align="center">
        <?php echo CHtml::button('Crear Tipo de bono', array('class' => 'btn btn-primary btn-sm', 'submit' => CController::createUrl('/callcenter/bonos/bonoTienda', array('opcion' => 'crear')))); ?>
