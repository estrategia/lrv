    ...
    <div class="col-md-7">
        <div>
            ...
            <div id="div-saldos-pdv">
                <?php $this->renderPartial('_saldosPDV', array('saldosPdv' => $objCompra->saldosPdv)) ?>
            </div>
        ...
        <div>
            ...
            <form action="/callcenter/index/generardoccruce/" method="post" id="asignarpdv" name="asignarpdv">
                <div class="row">
                    <div class="col-md-9">
                        <?php echo Select2::dropDownList('select-pdv-asignar', $objCompra->idComercial, CHtml::listData($listPdv, 'idComercial', function($model) {return "$model->idComercial - $model->nombrePuntoDeVenta";}), array('prompt' => 'Seleccione punto de venta', 'id' => 'select-pdv-asignar', 'style' => 'width: 100%;')) ?>
                    </div>
                    <div class="col-md-3">
