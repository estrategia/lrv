...
<div class="form-group">
    <?php echo $form->labelEx($model, 'nombreBodega'); ?>
    <?php echo $form->textField($model, 'nombreBodega', array('class' => 'form-control', 'size' => 20, 'maxlength' => 50)); ?>
    <?php echo $form->error($model, 'nombreBodega'); ?>
</div>
