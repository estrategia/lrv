<tr>
    <td>
        ...
        <div><span>Tiempo de entrega: <?php echo Yii::app()->getModule('callcenter')->getModule('telefarma')->shoppingCartVitalCall->getDeliveryStored() ?> hora(s)</span></div>
    </td>
    ...
    <td class="text-right">
        ...
        <?php if (Yii::app()->getModule('callcenter')->getModule('telefarma')->shoppingCartVitalCall->getObjCiudad()->excentoImpuestos == 0 && $position->getTax() > 0): ?>
            <br>
