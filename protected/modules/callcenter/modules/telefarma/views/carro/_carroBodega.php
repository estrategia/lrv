                ...
                <div class='row'>
                    <div class='col-md-12 text-justify' >
                       <?php if($tipo == 1):?>
                        ...
                        Las unidades restantes estaran disponibles en un tiempo de entrega de <?php echo Yii::app()->getModule('telefarma')->shoppingCartVitalCall->getDeliveryStored() ?> horas y con forma de pago en L&iacute;nea
                       <?php elseif ($tipo == 2): ?>
                       Lo sentimos, No contamos con unidades para entrega en condiciones normales.
        			   Las unidades estaran disponibles en un tiempo de entrega de  <?php echo Yii::app()->getModule('telefarma')->shoppingCartVitalCall->getDeliveryStored() ?> horas y con forma de pago en L&iacute;nea
                       <?php endif;?>   
                    </div>
                </div> 
