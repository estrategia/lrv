<div class="btn-group minicar">
    <a href="#" data-toggle="dropdown" data-placeholder="false" class="dropdown-toggle">
        ...
        <span id="cantidad-productos" class="cantidad-productos"><?php echo Yii::app()->getModule('telefarma')->shoppingCartVitalCall->getCount(); ?></span>
        <p style="color: #A3A3A3;margin:0;line-height: 16px;">Productos</p>
    </a>

    <ul class="dropdown-menu noclose pull-right">
        <li class="top">Hay <?php echo Yii::app()->getModule('telefarma')->shoppingCartVitalCall->getCount(); ?> producto(s) en el carro</li>
        <?php if (!Yii::app()->getModule('telefarma')->shoppingCartVitalCall->isEmpty()): ?>
            ...
            <li class="subtotal">Subtotal: <strong><?php echo Yii::app()->numberFormatter->format(Yii::app()->params->formatoMoneda['patron'], Yii::app()->getModule('telefarma')->shoppingCartVitalCall->getCost(), Yii::app()->params->formatoMoneda['moneda']); ?></strong></li>
            <li>
