...
class CotizarController extends ControllerVitalcall {
    ...
    public function actionUbicacion() {
        ...
        $redirect = Yii::app()->request->urlReferrer == null ? $this->createUrl('/callcenter/vitalcall_old/cliente') : Yii::app()->request->urlReferrer;
    ...
    public function actionUbicacionSeleccion() {
        ...
        $redirect = $this->createUrl('/callcenter/vitalcall_old/cotizar/buscar');
