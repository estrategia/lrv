<?php if ($objProducto->fraccionado == 1): ?>
    <tr>
        ...
        <td rowspan="2">
            <button data-producto="<?=$objProducto->codigoProducto?>" data-tipo="2" data-role="cargar-vitalcall" class="btn btn-primary btn-block btn-xs" type="button">Añadir <img alt="" src="/lrv/images/desktop/button-carrito.png"></button>
        </td>
    </tr>
    <tr>
        <td> 
