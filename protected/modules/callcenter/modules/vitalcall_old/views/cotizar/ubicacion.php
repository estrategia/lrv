        ...
        <section class="selectedUbicacion">
            ...
            <div class="blocktipoentrega">
                <div id="div-ubicacion-tipoubicacion" class="text-center">
                	<?php echo CHtml::htmlButton('<span class="glyphicon glyphicon-globe"></span>  Georeferencia', array('class' => 'btn ico-btn  btn-ciudad', 'data-role' => 'ubicacion-georeferencia')); ?>
