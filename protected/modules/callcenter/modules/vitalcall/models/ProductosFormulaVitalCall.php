...
class ProductosFormulaVitalCall extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('idFormula, idProductoVitallCall, cantidad, dosis, intervalo, fechaCreacion', 'required'),
			array('idFormula, idProductoVitallCall, cantidad, dosis, intervalo', 'length', 'max'=>10),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('idFormula, idProductoVitallCall, cantidad, dosis, intervalo, fechaCreacion', 'safe', 'on'=>'search'),
		);
	}
