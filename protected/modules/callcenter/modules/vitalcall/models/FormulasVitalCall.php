 ...
 * @property TProductosVitallCall[] $tProductosVitallCalls
 */
class FormulasVitalCall extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			...
			'tProductosVitallCalls' => array(self::MANY_MANY, 'TProductosVitallCall', 't_ProductosFormulaVitalCall(idFormula, idProductoVitallCall)'),
		);
	}
