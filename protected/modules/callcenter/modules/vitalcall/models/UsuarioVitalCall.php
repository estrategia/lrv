 ...
 * @property TDireccionesDespachoVitalCall[] $tDireccionesDespachoVitalCalls
...
class UsuarioVitalCall extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'tDireccionesDespachoVitalCalls' => array(self::HAS_MANY, 'TDireccionesDespachoVitalCall', 'identificacionUsuario'),
			'tFormulasVitalCalls' => array(self::HAS_MANY, 'TFormulasVitalCall', 'identificacionUsuario'),
		);
	}
