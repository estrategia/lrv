<?php if($modelPago->tieneDomicilio()): ?>
...
<input type="hidden" id="FormaPagoVitalCallForm_tipoEntrega" name="FormaPagoVitalCallForm[tipoEntrega]" value="<?php echo $modelPago->tipoEntrega?>">