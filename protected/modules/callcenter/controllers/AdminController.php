...
class AdminController extends ControllerOperator {
        ...
        if (isset($_POST['RemisionForm'])) {
            ...
            try {
                ...
                if (!$result[0] == 1) {
                    ...
                    Yii::app()->user->setFlash('alert alert-success', "La remisi贸n ha sido borrada con 茅xito del punto de venta " . $model->attributes['idComercial']);
                    /*
                      ...
                      // Guardar el cambio de estado de la remisi贸n
                      if (!$objCompra->save()) {
                      throw new Exception('Error de asignaci贸n: ' . $objCompra->validateErrorsResponse());
                      }
                      ...
                      $objObservacion->observacion = "Cambio de Estado: Remisi贸n borrada del POS del PDV. " . $objPuntoVenta->nombrePuntoDeVenta;
                      $objObservacion->idOperador = Yii::app()->controller->module->user->id;
                      $objObservacion->notificarCliente = 0;

                      // Guardar las observaciones
                      if (!$objObservacion->save()) {
                      throw new Exception("Error al guardar observaci贸n" . $objObservacion->validateErrorsResponse());
                      }
                    ...
                    Yii::app()->user->setFlash('alert alert-danger', "La remisi贸n no ha sido borrada con 茅xito del punto de venta " . $model->attributes['idComercial'] . "<br/>"
                            . $result[1]);
                }
                ...
                Yii::app()->user->setFlash('alert alert-danger', "Error  al borrar la remisi贸n por problemas de conexi贸n con el punto de venta " . $model->attributes['idComercial']);
            }
        }
    ...
    public function actionDetallepedido($pedido) {
        ...
        if ($asignar && $objCompra->idOperador == null && $objCompra->idEstadoCompra == Yii::app()->params->callcenter['estadoCompra']['estado']['pendiente']) {
            ...
            try {
                ...
                $objObservacion = new ComprasObservaciones;
                $objObservacion->idCompra = $objCompra->idCompra;
                $objObservacion->observacion = "Cambio de Estado: En Tr谩mite";
                $objObservacion->idOperador = Yii::app()->controller->module->user->id;
                $objObservacion->notificarCliente = 0;
    ...
    public function actionAprobarCalificacion() {
        ...
        if (!$model) {
            echo CJSON::encode(array('result' => 'error', 'response' => 'Esta calificaci贸n no existe'));
            Yii::app()->end();
        }
                ...
                if ($model->estado != null) {
                    ...
                    try {
                        ...
                        if ($estadoCompra == null) {
                            throw new Exception('Estado inv谩lido');
                        }
    ...
    public function loadModel($id) {
        ...
        if ($model === null)
            throw new CHttpException(404, 'La p谩gina solicitada no existe.');
        return $model;
    }
    ...
    public function actionSer(){
    	 echo "<pre>";
    	$serial = 'a:2:{i:0;a:12:{i:0;s:6:"CODIGO";i:1;s:11:"DESCRIPCION";i:2;s:3:"2W4";i:3;s:3:"216";i:4;s:3:"2F4";i:5;s:3:"218";i:6;i:-1;i:7;i:-1;i:8;i:-1;i:9;i:-1;i:10;i:-1;i:11;i:-1;}i:1;a:2:{i:0;a:13:{s:6:"CODIGO";s:6:"110856";s:11:"DESCRIPCION";s:39:"PANAL HUGGIES NATURAL CARE NI袮 ETAPA 5";s:15:"CANTIDAD_PEDIDA";s:1:"1";s:7:"SALDO_3";s:1:"3";s:7:"SALDO_4";s:1:"4";s:7:"SALDO_5";s:1:"2";s:7:"SALDO_6";s:1:"3";s:7:"SALDO_7";i:-1;s:7:"SALDO_8";i:-1;s:7:"SALDO_9";i:-1;s:8:"SALDO_10";i:-1;s:8:"SALDO_11";i:-1;s:8:"SALDO_12";i:-1;}i:1;a:13:{s:6:"CODIGO";s:5:"73201";s:11:"DESCRIPCION";s:66:"OFERTA PA袸TOS HUMEDOS PEQUE袸N KARITE PAGUE 70 LLEVE 100 UNIDADES";s:15:"CANTIDAD_PEDIDA";s:1:"1";s:7:"SALDO_3";s:1:"3";s:7:"SALDO_4";s:1:"1";s:7:"SALDO_5";s:1:"4";s:7:"SALDO_6";s:1:"2";s:7:"SALDO_7";i:-1;s:7:"SALDO_8";i:-1;s:7:"SALDO_9";i:-1;s:8:"SALDO_10";i:-1;s:8:"SALDO_11";i:-1;s:8:"SALDO_12";i:-1;}}}';
